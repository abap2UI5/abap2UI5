...
* Support for Serialization of variables created at runtime is handled via [**S-RTTI**](https://github.com/sandraros/S-RTTI) [(by sandrarossi)](https://github.com/sandraros)
