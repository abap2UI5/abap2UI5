...
* Support for XML Serialization of dynamically typed data is handled via [**S-RTTI**](https://github.com/sandraros/S-RTTI) [(by sandrarossi)](https://github.com/sandraros)
