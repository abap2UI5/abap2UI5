...
* pure ABAP – development using 100% ABAP source code (no JavaScript, DDL, EML or Customizing)
...
* take a look to the [wiki](https://github.com/oblomov-dev/ABAP2UI5/wiki) for setting up the theme, bootstrapping, title etc. 
