...
* [work-in-progress] Launchpads are supported with the follwowing extension [(abap2UI5_ext-launchpad)](https://github.com/oblomov-dev/abap2UI5_ext-launchpad_app)
