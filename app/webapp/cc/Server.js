        ...
        try {
          ...
          if (z2ui5.oResponse.PARAMS?.S_FOLLOW_UP_ACTION?.CUSTOM_JS) {
            setTimeout(() => {
              for (
                let i = 0;
                i < z2ui5.oResponse?.PARAMS.S_FOLLOW_UP_ACTION.CUSTOM_JS.length;
                i++
              ) {
                let mParams =
                  z2ui5.oResponse?.PARAMS.S_FOLLOW_UP_ACTION.CUSTOM_JS[i].split(
                    "'"
                  );
          ...
          if (z2ui5.oResponse.PARAMS?.S_VIEW?.XML) {
            if (z2ui5.oResponse.PARAMS?.S_VIEW?.XML !== "") {
              z2ui5.oController.ViewDestroy();
              await z2ui5.oController.displayView(
                z2ui5.oResponse.PARAMS.S_VIEW.XML,
          ...
          z2ui5.oController.updateModelIfRequired(
            "S_VIEW_NEST",
            z2ui5.oViewNest
          );
          z2ui5.oController.updateModelIfRequired(
