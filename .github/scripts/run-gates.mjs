...
const NOT_A_VERIFY_GATE = {
  ...
  "check:audit": "asks the npm registry about the whole dependency tree, not the working tree, and a new advisory would turn every unrelated pull request red - npm-audit.yaml runs it weekly and on lockfile changes",
};
