...
*                       ( n = `core:require` v = `{ URLHelper: 'sap/m/library/URLHelper' }` )
  ...
  ENDMETHOD.
   ...
   METHOD zfc_ddic_search_help.
     ...
     TYPES t_ty_ddshselops TYPE TABLE OF ty_ddshselops WITH NON-UNIQUE DEFAULT KEY.
     ...
     TYPES t_ty_ddshfprops TYPE TABLE OF ty_ddshfprops WITH NON-UNIQUE DEFAULT KEY.
     ...
     TYPES t_ty_ddfields TYPE TABLE OF ty_ddfields WITH NON-UNIQUE DEFAULT KEY.
     ...
     TYPES t_ty_ddshifaces TYPE TABLE OF ty_ddshifaces WITH NON-UNIQUE DEFAULT KEY.
