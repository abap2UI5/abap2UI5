...
CLASS z2ui5_cl_xml_view_cc IMPLEMENTATION.
  ...
  METHOD camera_picture.
    ...
    INSERT temp4 INTO TABLE temp3.
    temp4-n = `autoplay`.
    temp4-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( autoplay ).
    INSERT temp4 INTO TABLE temp3.
    temp4-n = `facingMode`.
    temp4-v = facingmode.
    INSERT temp4 INTO TABLE temp3.
  ...
  METHOD camera_selector.
    ...
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( showclearicon ).
    ...
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( showsecondaryvalues ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `visible`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( visible ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `showValueStateMessage`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( showvaluestatemessage ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `showButton`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( showbutton ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `required`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( required ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `editable`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( editable ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `enabled`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( enabled ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `filterSecondaryValues`.
    temp6-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( filtersecondaryvalues ).
    INSERT temp6 INTO TABLE temp5.
    temp6-n = `width`.
    temp6-v = width.
    INSERT temp6 INTO TABLE temp5.
  ...
  METHOD file_uploader.
    ...
    INSERT temp12 INTO TABLE temp11.
    temp12-n = `iconOnly`.
    temp12-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( icononly ).
    INSERT temp12 INTO TABLE temp11.
    temp12-n = `buttonOnly`.
    temp12-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( buttononly ).
    INSERT temp12 INTO TABLE temp11.
    temp12-n = `buttonText`.
    temp12-v = buttontext.
    INSERT temp12 INTO TABLE temp11.
    ...
    temp12-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( checkdirectupload ).
    INSERT temp12 INTO TABLE temp11.
    temp12-n = `icon`.
    temp12-v = icon.
    INSERT temp12 INTO TABLE temp11.
    temp12-n = `enabled`.
    temp12-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( enabled ).
    INSERT temp12 INTO TABLE temp11.
    mo_view->_generic(
        name   = `FileUploader`
        ns     = `z2ui5`
  ...
  METHOD geolocation.
    ...
    temp16-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( enablehighaccuracy ).
    INSERT temp16 INTO TABLE temp15.
    temp16-n = `timeout`.
    temp16-v = timeout.
    INSERT temp16 INTO TABLE temp15.
  ...
  METHOD timer.
    ...
    temp38-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( checkactive ).
    INSERT temp38 INTO TABLE temp37.
    temp38-n = `checkRepeat`.
    temp38-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( checkrepeat ).
    INSERT temp38 INTO TABLE temp37.
  ...
  METHOD websocket.
    ...
    temp42-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( checkactive ).
    INSERT temp42 INTO TABLE temp41.
    temp42-n = `checkRepeat`.
    temp42-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( checkrepeat ).
    INSERT temp42 INTO TABLE temp41.
  ...
  METHOD lp_title.
    ...
    temp44-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( applicationfullwidth ).
    INSERT temp44 INTO TABLE temp43.
    mo_view->_generic(
        name   = `LPTitle`
        ns     = `z2ui5`
  ...
  METHOD dirty.
    ...
    temp48-n = `isDirty`.
    temp48-v = z2ui5_cl_a2ui5_context=>boolean_abap_2_json( isdirty ).
