...
CLASS ltcl_string_ops IMPLEMENTATION.
  ...
  METHOD split_basic.
    ...
    FIELD-SYMBOLS <temp3> LIKE LINE OF lt_result.
    DATA temp4 LIKE sy-tabix.
    FIELD-SYMBOLS <temp5> LIKE LINE OF lt_result.
    DATA temp6 LIKE sy-tabix.
    FIELD-SYMBOLS <temp7> LIKE LINE OF lt_result.
    ...
    temp4 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp3>.
    sy-tabix = temp4.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp6 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp5>.
    sy-tabix = temp6.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp8 = sy-tabix.
    READ TABLE lt_result INDEX 3 ASSIGNING <temp7>.
    sy-tabix = temp8.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD split_no_sep.
    DATA lt_result TYPE string_table.
    FIELD-SYMBOLS <temp9> LIKE LINE OF lt_result.
    ...
    temp10 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp9>.
    sy-tabix = temp10.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD split_multi.
    DATA lt_result TYPE string_table.
    FIELD-SYMBOLS <temp11> LIKE LINE OF lt_result.
    DATA temp12 LIKE sy-tabix.
    FIELD-SYMBOLS <temp13> LIKE LINE OF lt_result.
    DATA temp14 LIKE sy-tabix.
    FIELD-SYMBOLS <temp15> LIKE LINE OF lt_result.
    ...
    temp12 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp11>.
    sy-tabix = temp12.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp14 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp13>.
    sy-tabix = temp14.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp16 = sy-tabix.
    READ TABLE lt_result INDEX 3 ASSIGNING <temp15>.
    sy-tabix = temp16.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD split_empty_parts.
    DATA lt_result TYPE string_table.
    FIELD-SYMBOLS <temp17> LIKE LINE OF lt_result.
    DATA temp18 LIKE sy-tabix.
    FIELD-SYMBOLS <temp19> LIKE LINE OF lt_result.
    DATA temp20 LIKE sy-tabix.
    FIELD-SYMBOLS <temp21> LIKE LINE OF lt_result.
    ...
    temp18 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp17>.
    sy-tabix = temp18.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp20 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp19>.
    sy-tabix = temp20.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp22 = sy-tabix.
    READ TABLE lt_result INDEX 3 ASSIGNING <temp21>.
    sy-tabix = temp22.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
CLASS ltcl_url_ops IMPLEMENTATION.
  ...
  METHOD param_get_tab_basic.
    ...
    FIELD-SYMBOLS <temp30> LIKE LINE OF lt_result.
    DATA temp31 LIKE sy-tabix.
    FIELD-SYMBOLS <temp32> LIKE LINE OF lt_result.
    DATA temp33 LIKE sy-tabix.
    FIELD-SYMBOLS <temp34> LIKE LINE OF lt_result.
    DATA temp35 LIKE sy-tabix.
    FIELD-SYMBOLS <temp36> LIKE LINE OF lt_result.
    ...
    temp31 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp30>.
    sy-tabix = temp31.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp33 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp32>.
    sy-tabix = temp33.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp35 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp34>.
    sy-tabix = temp35.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp37 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp36>.
    sy-tabix = temp37.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD param_get_tab_with_question.
    DATA lt_result TYPE z2ui5_cl_util=>ty_t_name_value.
    FIELD-SYMBOLS <temp38> LIKE LINE OF lt_result.
    ...
    temp39 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp38>.
    sy-tabix = temp39.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
CLASS ltcl_filter_ops IMPLEMENTATION.
  ...
  METHOD sql_roundtrip_eq.
    ...
    FIELD-SYMBOLS <temp71> LIKE LINE OF lt_filter.
    DATA temp72 LIKE sy-tabix.
    FIELD-SYMBOLS <temp73> LIKE LINE OF lt_filter.
    DATA temp74 LIKE sy-tabix.
    FIELD-SYMBOLS <temp13> LIKE LINE OF <temp73>-t_range.
    DATA temp14 LIKE sy-tabix.
    FIELD-SYMBOLS <temp75> LIKE LINE OF lt_filter.
    DATA temp76 LIKE sy-tabix.
    FIELD-SYMBOLS <temp15> LIKE LINE OF <temp75>-t_range.
    DATA temp16 LIKE sy-tabix.
    ...
    temp72 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp71>.
    sy-tabix = temp72.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp74 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp73>.
    sy-tabix = temp74.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp14 = sy-tabix.
    READ TABLE <temp73>-t_range INDEX 1 ASSIGNING <temp13>.
    sy-tabix = temp14.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp76 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp75>.
    sy-tabix = temp76.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp16 = sy-tabix.
    READ TABLE <temp75>-t_range INDEX 1 ASSIGNING <temp15>.
    sy-tabix = temp16.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD sql_roundtrip_bt.
    ...
    DATA lt_filter TYPE z2ui5_cl_util=>ty_t_filter_multi.
    FIELD-SYMBOLS <temp77> LIKE LINE OF lt_filter.
    DATA temp78 LIKE sy-tabix.
    FIELD-SYMBOLS <temp17> LIKE LINE OF <temp77>-t_range.
    DATA temp18 LIKE sy-tabix.
    FIELD-SYMBOLS <temp79> LIKE LINE OF lt_filter.
    DATA temp80 LIKE sy-tabix.
    FIELD-SYMBOLS <temp19> LIKE LINE OF <temp79>-t_range.
    DATA temp20 LIKE sy-tabix.
    FIELD-SYMBOLS <temp81> LIKE LINE OF lt_filter.
    DATA temp82 LIKE sy-tabix.
    FIELD-SYMBOLS <temp21> LIKE LINE OF <temp81>-t_range.
    DATA temp22 LIKE sy-tabix.
    ...
    temp78 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp77>.
    sy-tabix = temp78.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp18 = sy-tabix.
    READ TABLE <temp77>-t_range INDEX 1 ASSIGNING <temp17>.
    sy-tabix = temp18.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp80 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp79>.
    sy-tabix = temp80.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp20 = sy-tabix.
    READ TABLE <temp79>-t_range INDEX 1 ASSIGNING <temp19>.
    sy-tabix = temp20.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp82 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp81>.
    sy-tabix = temp82.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp22 = sy-tabix.
    READ TABLE <temp81>-t_range INDEX 1 ASSIGNING <temp21>.
    sy-tabix = temp22.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD sql_roundtrip_like.
    DATA lt_filter TYPE z2ui5_cl_util=>ty_t_filter_multi.
    FIELD-SYMBOLS <temp83> LIKE LINE OF lt_filter.
    DATA temp84 LIKE sy-tabix.
    FIELD-SYMBOLS <temp23> LIKE LINE OF <temp83>-t_range.
    DATA temp24 LIKE sy-tabix.
    FIELD-SYMBOLS <temp85> LIKE LINE OF lt_filter.
    DATA temp86 LIKE sy-tabix.
    FIELD-SYMBOLS <temp25> LIKE LINE OF <temp85>-t_range.
    ...
    temp84 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp83>.
    sy-tabix = temp84.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp24 = sy-tabix.
    READ TABLE <temp83>-t_range INDEX 1 ASSIGNING <temp23>.
    sy-tabix = temp24.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp86 = sy-tabix.
    READ TABLE lt_filter INDEX 1 ASSIGNING <temp85>.
    sy-tabix = temp86.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp26 = sy-tabix.
    READ TABLE <temp85>-t_range INDEX 1 ASSIGNING <temp25>.
    sy-tabix = temp26.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD token_range_mapping.
    DATA lt_result TYPE z2ui5_cl_util=>ty_t_name_value.
    FIELD-SYMBOLS <temp87> LIKE LINE OF lt_result.
    DATA temp88 LIKE sy-tabix.
    FIELD-SYMBOLS <temp89> LIKE LINE OF lt_result.
    DATA temp90 LIKE sy-tabix.
    FIELD-SYMBOLS <temp91> LIKE LINE OF lt_result.
    DATA temp92 LIKE sy-tabix.
    FIELD-SYMBOLS <temp93> LIKE LINE OF lt_result.
    ...
    temp88 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `EQ` ASSIGNING <temp87>.
    sy-tabix = temp88.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp90 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `LT` ASSIGNING <temp89>.
    sy-tabix = temp90.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp92 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `GT` ASSIGNING <temp91>.
    sy-tabix = temp92.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp94 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `BT` ASSIGNING <temp93>.
    sy-tabix = temp94.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lt_tab TYPE temp2.
    ...
    FIELD-SYMBOLS <temp99> LIKE LINE OF lt_tab.
    DATA temp100 LIKE sy-tabix.
    FIELD-SYMBOLS <temp101> LIKE LINE OF lt_tab.
    ...
    temp100 = sy-tabix.
    READ TABLE lt_tab INDEX 1 ASSIGNING <temp99>.
    sy-tabix = temp100.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp102 = sy-tabix.
    READ TABLE lt_tab INDEX 2 ASSIGNING <temp101>.
    sy-tabix = temp102.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
CLASS ltcl_deep_ops IMPLEMENTATION.
  ...
  METHOD diff_one_field.
    ...
    DATA lt_diff TYPE z2ui5_cl_util=>ty_t_field_diff.
    FIELD-SYMBOLS <temp111> LIKE LINE OF lt_diff.
    DATA temp112 LIKE sy-tabix.
    FIELD-SYMBOLS <temp113> LIKE LINE OF lt_diff.
    DATA temp114 LIKE sy-tabix.
    FIELD-SYMBOLS <temp115> LIKE LINE OF lt_diff.
    ...
    temp112 = sy-tabix.
    READ TABLE lt_diff INDEX 1 ASSIGNING <temp111>.
    sy-tabix = temp112.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp114 = sy-tabix.
    READ TABLE lt_diff INDEX 1 ASSIGNING <temp113>.
    sy-tabix = temp114.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp116 = sy-tabix.
    READ TABLE lt_diff INDEX 1 ASSIGNING <temp115>.
    sy-tabix = temp116.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lt_tab TYPE temp3.
    ...
    FIELD-SYMBOLS <temp124> LIKE LINE OF lt_tab.
    DATA temp125 LIKE sy-tabix.
    FIELD-SYMBOLS <temp126> LIKE LINE OF lt_tab.
    DATA temp127 LIKE sy-tabix.
    FIELD-SYMBOLS <temp128> LIKE LINE OF lt_tab.
    ...
    temp125 = sy-tabix.
    READ TABLE lt_tab INDEX 1 ASSIGNING <temp124>.
    sy-tabix = temp125.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp127 = sy-tabix.
    READ TABLE lt_tab INDEX 2 ASSIGNING <temp126>.
    sy-tabix = temp127.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp129 = sy-tabix.
    READ TABLE lt_tab INDEX 3 ASSIGNING <temp128>.
    sy-tabix = temp129.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lt_tab TYPE temp4.
    ...
    FIELD-SYMBOLS <temp132> LIKE LINE OF lt_tab.
    DATA temp133 LIKE sy-tabix.
    FIELD-SYMBOLS <temp134> LIKE LINE OF lt_tab.
    DATA temp135 LIKE sy-tabix.
    FIELD-SYMBOLS <temp136> LIKE LINE OF lt_tab.
    ...
    temp133 = sy-tabix.
    READ TABLE lt_tab INDEX 1 ASSIGNING <temp132>.
    sy-tabix = temp133.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp135 = sy-tabix.
    READ TABLE lt_tab INDEX 2 ASSIGNING <temp134>.
    sy-tabix = temp135.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp137 = sy-tabix.
    READ TABLE lt_tab INDEX 3 ASSIGNING <temp136>.
    sy-tabix = temp137.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lt_tab TYPE temp11.
    ...
    DATA lt_result TYPE z2ui5_cl_util=>ty_t_name_value.
    FIELD-SYMBOLS <temp152> LIKE LINE OF lt_result.
    DATA temp153 LIKE sy-tabix.
    FIELD-SYMBOLS <temp154> LIKE LINE OF lt_result.
    ...
    temp153 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `A` ASSIGNING <temp152>.
    sy-tabix = temp153.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp155 = sy-tabix.
    READ TABLE lt_result WITH KEY n = `B` ASSIGNING <temp154>.
    sy-tabix = temp155.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lt_dst TYPE temp15.
    ...
    FIELD-SYMBOLS <temp162> LIKE LINE OF lt_dst.
    DATA temp163 LIKE sy-tabix.
    FIELD-SYMBOLS <temp164> LIKE LINE OF lt_dst.
    ...
    temp163 = sy-tabix.
    READ TABLE lt_dst INDEX 1 ASSIGNING <temp162>.
    sy-tabix = temp163.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp165 = sy-tabix.
    READ TABLE lt_dst INDEX 1 ASSIGNING <temp164>.
    sy-tabix = temp165.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD get_by_struc_basic.
    ...
    DATA lt_result TYPE z2ui5_cl_util=>ty_t_name_value.
    FIELD-SYMBOLS <temp167> LIKE LINE OF lt_result.
    DATA temp168 LIKE sy-tabix.
    FIELD-SYMBOLS <temp169> LIKE LINE OF lt_result.
    DATA temp170 LIKE sy-tabix.
    FIELD-SYMBOLS <temp171> LIKE LINE OF lt_result.
    DATA temp172 LIKE sy-tabix.
    FIELD-SYMBOLS <temp173> LIKE LINE OF lt_result.
    ...
    temp168 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp167>.
    sy-tabix = temp168.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp170 = sy-tabix.
    READ TABLE lt_result INDEX 1 ASSIGNING <temp169>.
    sy-tabix = temp170.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp172 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp171>.
    sy-tabix = temp172.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp174 = sy-tabix.
    READ TABLE lt_result INDEX 2 ASSIGNING <temp173>.
    sy-tabix = temp174.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
