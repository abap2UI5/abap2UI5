...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_info.
    ...
    FIELD-SYMBOLS <temp3> LIKE LINE OF lt_msg.
    ...
    temp4 = sy-tabix.
    READ TABLE lt_msg INDEX 1 ASSIGNING <temp3>.
    sy-tabix = temp4.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_error.
    ...
    DATA lo_log TYPE REF TO z2ui5_cl_util_log.
    DATA lt_msg TYPE z2ui5_cl_util=>ty_t_msg.
    FIELD-SYMBOLS <temp5> LIKE LINE OF lt_msg.
    ...
    temp6 = sy-tabix.
    READ TABLE lt_msg INDEX 1 ASSIGNING <temp5>.
    sy-tabix = temp6.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_success.
    ...
    DATA lo_log TYPE REF TO z2ui5_cl_util_log.
    DATA lt_msg TYPE z2ui5_cl_util=>ty_t_msg.
    FIELD-SYMBOLS <temp9> LIKE LINE OF lt_msg.
    ...
    temp10 = sy-tabix.
    READ TABLE lt_msg INDEX 1 ASSIGNING <temp9>.
    sy-tabix = temp10.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_to_msg.
    ...
    DATA lo_log TYPE REF TO z2ui5_cl_util_log.
    DATA lt_msg TYPE z2ui5_cl_util=>ty_t_msg.
    FIELD-SYMBOLS <temp11> LIKE LINE OF lt_msg.
    DATA temp12 LIKE sy-tabix.
    FIELD-SYMBOLS <temp13> LIKE LINE OF lt_msg.
    ...
    temp12 = sy-tabix.
    READ TABLE lt_msg INDEX 1 ASSIGNING <temp11>.
    sy-tabix = temp12.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp14 = sy-tabix.
    READ TABLE lt_msg INDEX 2 ASSIGNING <temp13>.
    sy-tabix = temp14.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
