...
DATA lt_logs TYPE temp3.
  ...
  METHOD bal_read_latest.
    ...
    DATA lt_msgs TYPE z2ui5_cl_util=>ty_t_msg.
      FIELD-SYMBOLS <temp44> LIKE LINE OF lt_msgs.
    ...
    IF lt_msgs IS NOT INITIAL.
      ...
      temp45 = sy-tabix.
      READ TABLE lt_msgs INDEX lines( lt_msgs ) ASSIGNING <temp44>.
      sy-tabix = temp45.
      IF sy-subrc <> 0.
        ASSERT 1 = 0.
      ENDIF.
...
DATA lt_logs TYPE temp7.
      DATA lv_class TYPE string.
          DATA lo_log LIKE LINE OF lt_logs.
          FIELD-SYMBOLS <temp11> LIKE LINE OF lt_logs.
    ...
    IF z2ui5_cl_util=>context_check_abap_cloud( ) IS NOT INITIAL.
      ...
      TRY.
          ...
          temp12 = sy-tabix.
          READ TABLE lt_logs INDEX 1 ASSIGNING <temp11>.
          sy-tabix = temp12.
          IF sy-subrc <> 0.
            ASSERT 1 = 0.
          ENDIF.
...
DATA lt_transports TYPE temp10.
  ...
  METHOD tr_copy_objects.
    ...
    TRY.
        ...
        lv_type_name = `TRWBO_REQUEST_HEADERS`.
        CREATE DATA lr_headers TYPE (lv_type_name).
        ASSIGN lr_headers->* TO <headers>.
