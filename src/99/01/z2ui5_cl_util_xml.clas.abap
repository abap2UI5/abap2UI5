...
CLASS z2ui5_cl_util_xml IMPLEMENTATION.
  ...
  METHOD __.
    ...
    DATA lo_child TYPE REF TO z2ui5_cl_util_xml.
      DATA temp27 TYPE z2ui5_cl_a2ui5_context=>ty_s_name_value.
  ...
  METHOD xml_get_parts.
    ...
    LOOP AT mt_prop INTO row WHERE v <> ``.
      ...
      ELSE.
        temp1 = row-v.
      ENDIF.
      val = |{ val } { row-n }="{ escape( val = temp1 format = z2ui5_cl_a2ui5_context=>cv_format_e_xml_attr ) }"|.
    ENDLOOP.
    temp31 = val.
  ...
  METHOD xml_get_parts_indent.
    ...
    LOOP AT mt_prop INTO row WHERE v <> ``.
      ...
      ELSE.
        temp2 = row-v.
      ENDIF.
      val = |{ val } { row-n }="{ escape( val = temp2 format = z2ui5_cl_a2ui5_context=>cv_format_e_xml_attr ) }"|.
    ENDLOOP.
    temp38 = val.
