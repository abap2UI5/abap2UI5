CLASS z2ui5_cl_util_xml DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS __
      IMPORTING
        ...
        p             TYPE z2ui5_cl_ui5_util_context=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO z2ui5_cl_util_xml.
  ...
  PROTECTED SECTION.
    ...
    DATA mt_prop   TYPE SORTED TABLE OF z2ui5_cl_ui5_util_context=>ty_s_name_value WITH NON-UNIQUE KEY n.
...
CLASS z2ui5_cl_util_xml IMPLEMENTATION.
  ...
  METHOD __.
    ...
    DATA lo_child TYPE REF TO z2ui5_cl_util_xml.
      DATA temp27 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
  ...
  METHOD p.
    ...
    DATA temp28 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    CLEAR temp28.
    temp28-n = n.
    temp28-v = v.
  ...
  METHOD xml_get_parts.
    ...
    LOOP AT mt_prop INTO row WHERE v <> ``.
      ...
      ELSE.
        temp1 = row-v.
      ENDIF.
      val = |{ val } { row-n }="{ escape( val = temp1 format = z2ui5_cl_ui5_util_context=>cv_format_e_xml_attr ) }"|.
    ENDLOOP.
    temp31 = val.
  ...
  METHOD xml_get_parts_indent.
    ...
    LOOP AT mt_prop INTO row WHERE v <> ``.
      ...
      ELSE.
        temp2 = row-v.
      ENDIF.
      val = |{ val } { row-n }="{ escape( val = temp2 format = z2ui5_cl_ui5_util_context=>cv_format_e_xml_attr ) }"|.
    ENDLOOP.
    temp38 = val.
