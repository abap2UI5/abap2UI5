...
CLASS z2ui5_cl_pop_data IMPLEMENTATION.
  ...
  METHOD display.
    ...
    IF z2ui5_cl_ui5_util_context=>rtti_check_table( <data> ).

      client->nav_app_call( z2ui5_cl_pop_table=>factory( i_tab   = <data>
                                                         i_title = title ) ).

    ELSEIF z2ui5_cl_ui5_util_context=>rtti_check_structure( <data> ).

      DATA(lt_result) = z2ui5_cl_ui5_util_context=>itab_get_by_struc( <data> ).
