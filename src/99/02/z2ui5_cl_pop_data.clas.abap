...
CLASS z2ui5_cl_pop_data IMPLEMENTATION.
  ...
  METHOD display.
    ...
    FIELD-SYMBOLS <data> TYPE any.
      DATA lt_result TYPE z2ui5_cl_ui5_util_context=>ty_t_name_value.

    ASSIGN mr_data->* TO <data>.

    IF z2ui5_cl_ui5_util_context=>rtti_check_table( <data> ) IS NOT INITIAL.

      client->nav_app_call( z2ui5_cl_pop_table=>factory( i_tab   = <data>
                                                         i_title = title ) ).

    ELSEIF z2ui5_cl_ui5_util_context=>rtti_check_structure( <data> ) IS NOT INITIAL.


      lt_result = z2ui5_cl_ui5_util_context=>itab_get_by_struc( <data> ).
