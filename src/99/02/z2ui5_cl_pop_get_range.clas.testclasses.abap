...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_confirm_builds_range.
    ...
    DATA ls_result TYPE z2ui5_cl_pop_get_range=>ty_s_result.
    FIELD-SYMBOLS <temp14> LIKE LINE OF ls_result-t_range.
    DATA temp15 LIKE sy-tabix.
    FIELD-SYMBOLS <temp16> LIKE LINE OF ls_result-t_range.
    DATA temp17 LIKE sy-tabix.
    FIELD-SYMBOLS <temp18> LIKE LINE OF ls_result-t_range.
    ...
    temp15 = sy-tabix.
    READ TABLE ls_result-t_range INDEX 1 ASSIGNING <temp14>.
    sy-tabix = temp15.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp17 = sy-tabix.
    READ TABLE ls_result-t_range INDEX 1 ASSIGNING <temp16>.
    sy-tabix = temp17.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp19 = sy-tabix.
    READ TABLE ls_result-t_range INDEX 1 ASSIGNING <temp18>.
    sy-tabix = temp19.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_delete_row.
    ...
    FIELD-SYMBOLS <temp2> LIKE LINE OF lo_pop->mt_filter.
    ...
    temp3 = sy-tabix.
    READ TABLE lo_pop->mt_filter INDEX 1 ASSIGNING <temp2>.
    sy-tabix = temp3.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
