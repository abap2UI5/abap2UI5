...
CLASS z2ui5_cl_pop_to_select IMPLEMENTATION.
  ...
  METHOD display.
    ...
    DATA(tab) = popup->table_select_dialog(
        items            = |\{path:'|
                          ...
                          && z2ui5_cl_ui5_context=>boolean_abap_2_json( descending )
                          && | \} \}|
    ...
    LOOP AT lt_comp INTO ls_comp.
      DATA(text) = COND #(
                     LET data_element_name = z2ui5_cl_ui5_context=>rtti_get_ddic_type_name( ls_comp-type )
                         medium_label = z2ui5_cl_ui5_context=>rtti_get_data_element_texts( data_element_name )-medium IN
  ...
  METHOD set_output_table.
    ...
    DATA(ls_sel_tab_type) = z2ui5_cl_ui5_context=>rtti_create_sel_tab_type( ir_tab = mr_tab
  ...
  METHOD on_event_search.
    ...
    z2ui5_cl_ui5_context=>itab_filter_by_val( EXPORTING val = client->get_event_arg( 1 )
