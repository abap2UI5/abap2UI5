...
CLASS ltcl_test_cc IMPLEMENTATION.
  ...
  METHOD test_uploadset_ext.
    ...
    temp35 = boolc( lv_xml CS `UploadSetExt` ).
    temp_a = temp35.
    cl_abap_unit_assert=>assert_true( temp_a ).


    temp36 = boolc( lv_xml CS `myUploadSet` ).
    temp_b = temp36.
  ...
  METHOD test_uitableext.
    ...
    temp37 = boolc( lv_xml CS `UITableExt` ).
    temp5 = temp37.
    cl_abap_unit_assert=>assert_true( temp5 ).


    temp38 = boolc( lv_xml CS `myTable` ).
    temp6 = temp38.
    cl_abap_unit_assert=>assert_true( temp6 ).
  ...
  METHOD test_camera_selector.
    ...
    temp39 = boolc( lv_xml CS `CameraSelector` ).
    temp7 = temp39.
    cl_abap_unit_assert=>assert_true( temp7 ).


    temp40 = boolc( lv_xml CS `Select camera` ).
    temp8 = temp40.
    cl_abap_unit_assert=>assert_true( temp8 ).
  ...
  METHOD test_spreadsheet_export.
    ...
    temp41 = boolc( lv_xml CS `ExportSpreadsheet` ).
    temp9 = temp41.
    cl_abap_unit_assert=>assert_true( temp9 ).


    temp42 = boolc( lv_xml CS `exportTable` ).
    temp10 = temp42.
    cl_abap_unit_assert=>assert_true( temp10 ).
  ...
  METHOD test_message_manager.
    ...
    temp43 = boolc( lv_xml CS `MessageManager` ).
    temp11 = temp43.
    cl_abap_unit_assert=>assert_true( temp11 ).


    temp44 = boolc( lv_xml CS `{/MESSAGES}` ).
    temp12 = temp44.
    cl_abap_unit_assert=>assert_true( temp12 ).
  ...
  METHOD test_scrolling.
    ...
    temp45 = boolc( lv_xml CS `Scrolling` ).
    temp13 = temp45.
    cl_abap_unit_assert=>assert_true( temp13 ).


    temp46 = boolc( lv_xml CS `onScroll` ).
    temp14 = temp46.
    cl_abap_unit_assert=>assert_true( temp14 ).
  ...
  METHOD test_tree.
    ...
    temp47 = boolc( lv_xml CS `Tree` ).
    temp15 = temp47.
    cl_abap_unit_assert=>assert_true( temp15 ).


    temp48 = boolc( lv_xml CS `myTree` ).
    temp16 = temp48.
    cl_abap_unit_assert=>assert_true( temp16 ).
  ...
  METHOD test_websocket.
    ...
    temp49 = boolc( lv_xml CS `Websocket` ).
    temp17 = temp49.
    cl_abap_unit_assert=>assert_true( temp17 ).


    temp50 = boolc( lv_xml CS `/ws/mypath` ).
    temp18 = temp50.
    cl_abap_unit_assert=>assert_true( temp18 ).
  ...
  METHOD test_binding_update.
    ...
    temp51 = boolc( lv_xml CS `BindingUpdate` ).
    temp19 = temp51.
    cl_abap_unit_assert=>assert_true( temp19 ).


    temp52 = boolc( lv_xml CS `onChanged` ).
    temp20 = temp52.
    cl_abap_unit_assert=>assert_true( temp20 ).
  ...
  METHOD test_chartjs.
    ...
    temp53 = boolc( lv_xml CS `chartjs` ).
    temp21 = temp53.
    cl_abap_unit_assert=>assert_true( temp21 ).


    temp54 = boolc( lv_xml CS `chart1` ).
    temp22 = temp54.
    cl_abap_unit_assert=>assert_true( temp22 ).
  ...
  METHOD test_approve_popover.
    ...
    temp55 = boolc( lv_xml CS `Popover` ).
    temp23 = temp55.
    cl_abap_unit_assert=>assert_true( temp23 ).


    temp56 = boolc( lv_xml CS `Are you sure?` ).
    temp24 = temp56.
    cl_abap_unit_assert=>assert_true( temp24 ).


    temp57 = boolc( lv_xml CS `onConfirm` ).
    temp25 = temp57.
    cl_abap_unit_assert=>assert_true( temp25 ).
