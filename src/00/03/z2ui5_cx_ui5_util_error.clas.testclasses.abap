...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_uuid_populated.
    ...
    TRY.
      ...
      CATCH z2ui5_cx_ui5_util_error INTO lx.
        ...
        lv_text = z2ui5_cx_ui5_util_error=>get_text_full( lx ).
        ...
        temp3 = boolc( lv_text CS lx->ms_error-uuid ).
  ...
  METHOD test_text_full_chain.
    ...
    temp4 = boolc( lv_text CS `--- error ---` ).
    cl_abap_unit_assert=>assert_true( temp4 ).

    temp5 = boolc( lv_text CS `outer problem` ).
    cl_abap_unit_assert=>assert_true( temp5 ).

    temp6 = boolc( lv_text CS `root cause` ).
    cl_abap_unit_assert=>assert_true( temp6 ).

    temp7 = boolc( lv_text CS `exception chain` ).
    cl_abap_unit_assert=>assert_true( temp7 ).

    temp8 = boolc( lv_text CS `[1] Z2UI5_CX_UI5_UTIL_ERROR` ).
    cl_abap_unit_assert=>assert_true( temp8 ).

    temp9 = boolc( lv_text CS `[2] Z2UI5_CX_UI5_UTIL_ERROR` ).
    cl_abap_unit_assert=>assert_true( temp9 ).

    temp10 = boolc( lv_text CS `context` ).
  ...
  METHOD test_text_full_any_cx.
    ...
    temp11 = boolc( lv_text CS `[1] CX_SY_ZERODIVIDE` ).
    cl_abap_unit_assert=>assert_true( temp11 ).

    temp12 = boolc( lv_text CS `exception chain` ).
  ...
  METHOD test_chain_bounded.
    ...
    temp13 = boolc( z2ui5_cx_ui5_util_error=>get_text_full( lx ) CS `chain truncated` ).
    cl_abap_unit_assert=>assert_true(
      temp13 ).
    cl_abap_unit_assert=>assert_not_initial( lx->get_text( ) ).
