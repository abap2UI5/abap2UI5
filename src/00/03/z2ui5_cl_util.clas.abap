    ...
    ELSE.
      ...
      LOOP AT val INTO ls_filter.
        ...
        LOOP AT ls_filter-t_range INTO ls_range.
          ...
          CLEAR temp53.
          temp53-fnam = ls_filter-name.
          temp53-sign = ls_range-sign.
          temp53-option = ls_range-option.
          temp53-low = ls_range-low.
          temp53-high = ls_range-high.
          INSERT temp53 INTO TABLE lt_range.
