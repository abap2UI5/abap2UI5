...
CLASS ltcl_unit_test_api IMPLEMENTATION.
  ...
  METHOD test_bal_read.
    ...
    DATA(lt_result) = z2ui5_cl_util=>bal_read( object    = `TEST`
                                                    subobject = `TEST`
                                                    id        = `TEST` ) ##NEEDED.
  ...
  METHOD test_bal_create.
    ...
    z2ui5_cl_util=>bal_create( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST`
                                   t_log     = lt_log ).
  ...
  METHOD test_bal_update.
    ...
    DATA lt_log TYPE z2ui5_cl_util=>ty_t_msg.
    z2ui5_cl_util=>bal_update( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST`
                                   t_log     = lt_log ).
  ...
  METHOD test_bal_delete.
    ...
    z2ui5_cl_util=>bal_delete( object    = `TEST`
                                   subobject = `TEST`
                                   id        = `TEST` ).
