...
CLASS z2ui5_cl_ui5_util_context IMPLEMENTATION.
  ...
  METHOD boolean_check_by_data.
        ...
        DATA temp97 TYPE z2ui5_cl_ui5_util_context=>ty_s_bool_cache.
    ...
    TRY.
        ...
        CLEAR temp97.
        temp97-typedescr = lo_descr.
        temp97-is_bool = result.
        INSERT temp97 INTO TABLE mt_bool_cache.
  ...
  METHOD filter_get_token_range_mapping.
    ...
    DATA temp98 TYPE z2ui5_cl_ui5_util_context=>ty_t_name_value.
  ...
  METHOD filter_get_token_t_by_range_t.
    ...
    DATA temp100 LIKE LINE OF lt_tab.
    DATA lr_row LIKE REF TO temp100.
      DATA lv_value TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value-v.
      FIELD-SYMBOLS <temp4> LIKE LINE OF lt_mapping.
      DATA temp5 LIKE sy-tabix.
      DATA temp101 TYPE z2ui5_cl_ui5_util_context=>ty_s_token.
    ...
    LOOP AT lt_tab REFERENCE INTO lr_row.
      ...
      CLEAR temp101.
      temp101-key = lv_value.
      temp101-text = lv_value.
      temp101-visible = abap_true.
      temp101-editable = abap_true.
  ...
  METHOD itab_filter_by_val.
    ...
    DATA temp102 TYPE string.
    DATA lv_search LIKE temp102.
  ...
  METHOD rtti_check_class_exists.
    ...
    DATA temp103 TYPE z2ui5_cl_ui5_util_context=>ty_s_class_exists.
    ...
    CLEAR temp103.
    temp103-name = lv_name.
    temp103-exists = result.
    INSERT temp103 INTO TABLE gt_class_exists.

  ENDMETHOD.

  METHOD rtti_check_ref_data.
        DATA lo_typdescr TYPE REF TO cl_abap_typedescr.
        DATA temp104 TYPE REF TO cl_abap_refdescr.
    ...
    TRY.
        ...
        lo_referenced = temp104->get_referenced_type( ).
  ...
  METHOD expand_components.
    DATA temp105 LIKE LINE OF val.
    DATA lr_comp LIKE REF TO temp105.
  ...
  METHOD rtti_get_t_attri_by_oref.
    ...
    DATA temp106 TYPE REF TO cl_abap_classdescr.
    temp106 ?= cl_abap_objectdescr=>describe_by_object_ref( val ).
    result = temp106->attributes.
  ...
  METHOD rtti_get_t_attri_by_any.
    ...
    DATA lv_absolute_name TYPE string.
        DATA temp107 TYPE REF TO cl_abap_structdescr.
        DATA temp108 TYPE REF TO cl_abap_structdescr.
        DATA temp8 TYPE REF TO cl_abap_tabledescr.
    DATA lr_cache TYPE REF TO z2ui5_cl_ui5_util_context=>ty_s_attri_cache.
      DATA temp109 TYPE z2ui5_cl_ui5_util_context=>ty_s_attri_cache.
    ...
    CASE lo_type->kind.
      ...
      WHEN cl_abap_typedescr=>kind_table.
        ...
        temp8 ?= lo_type.
        temp108 ?= temp8->get_table_line_type( ).
        lo_struct = temp108.
      WHEN OTHERS.
        lo_struct ?= lo_type.
    ENDCASE.
    ...
    ELSE.
      ...
      CLEAR temp109.
      temp109-absolute_name = lv_absolute_name.
      temp109-o_struct = lo_struct.
      temp109-t_attri = result.
      INSERT temp109 INTO TABLE mt_attri_cache.
    ENDIF.
  ...
  METHOD url_param_get.
    ...
    DATA temp110 TYPE string.
    DATA temp111 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    ...
    READ TABLE lt_params INTO temp111 WITH KEY n = lv_val.
    IF sy-subrc = 0.
      temp110 = temp111-v.
    ENDIF.
    result = temp110. "#EC CI_SORTSEQ
...
DATA lt_param TYPE temp1.
    DATA temp112 LIKE LINE OF lt_param.
    DATA lr_param LIKE REF TO temp112.
      DATA lv_name TYPE string.
      DATA lv_value TYPE string.
      DATA temp113 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    lv_search = val.
    IF lv_search CS `?`.
    ...
    LOOP AT lt_param REFERENCE INTO lr_param.
      ...
      CLEAR temp113.
      temp113-n = c_trim_lower( lv_name ).
      temp113-v = lv_value.
      INSERT temp113 INTO TABLE result.
    ENDLOOP.
  ...
  METHOD xml_srtti_descr.
    ...
    DATA lv_classname LIKE temp114.
    IF rtti_check_class_exists( `ZCL_SRTTI_TYPEDESCR` ) = abap_true.
      temp114 = `ZCL_SRTTI_TYPEDESCR`.
    ELSE.
      temp114 = `Z2UI5_CL_SRT_TYPEDESCR`.
    ENDIF.

    lv_classname = temp114.
  ...
  METHOD itab_get_by_struc.
    ...
    DATA temp115 LIKE LINE OF lt_attri.
    DATA lr_attri LIKE REF TO temp115.
      FIELD-SYMBOLS <component> TYPE any.
          DATA temp116 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    ...
    LOOP AT lt_attri REFERENCE INTO lr_attri.
      ...
      CASE rtti_get_type_kind( <component> ).
        ...
        WHEN OTHERS.
          ...
          CLEAR temp116.
          temp116-n = lr_attri->name.
          temp116-v = <component>.
          INSERT temp116 INTO TABLE result.
      ENDCASE.
  ...
  METHOD error_get_attributes.
    ...
    DATA lr_attri LIKE REF TO temp117.
      DATA temp118 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
  ...
  METHOD rtti_get_ddic_type_name.
    ...
    temp119 ?= type.
    result = substring_after( val = temp119->absolute_name
                              sub = `\TYPE=` ).
  ...
  METHOD rtti_check_table_standard.
        DATA lo_type TYPE REF TO cl_abap_typedescr.
        DATA temp120 TYPE REF TO cl_abap_tabledescr.
    ...
    TRY.
        ...
        temp4 = boolc( temp120->table_kind = cl_abap_tabledescr=>tablekind_std ).
        result = temp4.
      CATCH cx_root ##NO_HANDLER.
    ENDTRY.
  ...
  METHOD rtti_create_sel_tab_type.
    ...
    DATA lo_table LIKE temp121.
        DATA temp122 TYPE REF TO cl_abap_structdescr.
        DATA lo_struct LIKE temp122.
        DATA temp123 TYPE REF TO cl_abap_elemdescr.
        DATA lo_elem LIKE temp123.
        DATA temp124 TYPE abap_componentdescr.
    DATA temp125 LIKE sy-subrc.
      DATA lo_type_bool TYPE REF TO cl_abap_typedescr.
      DATA temp126 TYPE abap_componentdescr.
      DATA temp9 TYPE REF TO cl_abap_datadescr.
    DATA lo_line_type TYPE REF TO cl_abap_structdescr.
    ASSIGN ir_tab->* TO <tab>.


    temp121 ?= cl_abap_typedescr=>describe_by_data( <tab> ).

    lo_table = temp121.
    TRY.

        temp122 ?= lo_table->get_table_line_type( ).
      ...
      CATCH cx_root.
        ...
        temp123 ?= lo_table->get_table_line_type( ).

        lo_elem = temp123.

        CLEAR temp124.
        temp124-name = `TAB_LINE`.
        temp124-type = lo_elem.
        INSERT temp124 INTO TABLE lt_comp.
    ENDTRY.
    ...
    IF add_sel_field = abap_true
        AND NOT temp125 = 0. "#EC CI_SORTSEQ

      lo_type_bool = cl_abap_typedescr=>describe_by_name( `ABAP_BOOL` ).

      CLEAR temp126.
      temp126-name = sel_field_name.

      temp9 ?= lo_type_bool.
      temp126-type = temp9.
      INSERT temp126 INTO TABLE lt_comp.
    ENDIF.
  ...
  METHOD rtti_check_table.
    ...
    temp5 = boolc( rtti_get_type_kind( val ) = cl_abap_typedescr=>typekind_table ).
    result = temp5.
  ...
  METHOD ui5_msg_box_format.
    ...
    DATA temp11 LIKE sy-tabix.
      FIELD-SYMBOLS <temp127> LIKE LINE OF lt_msg.
      DATA temp128 LIKE sy-tabix.
    DATA lt_detail_items TYPE string_table.
    DATA temp129 LIKE LINE OF lt_msg.
    DATA lr_msg LIKE REF TO temp129.
      DATA temp130 LIKE LINE OF lt_detail_items.
    ...
    IF lv_lines = 1.
      ...
      temp128 = sy-tabix.
      READ TABLE lt_msg INDEX 1 ASSIGNING <temp127>.
      sy-tabix = temp128.
      IF sy-subrc <> 0.
        ASSERT 1 = 0.
      ENDIF.
      result-text = <temp127>-text.
      RETURN.
    ENDIF.
    ...
    LOOP AT lt_msg REFERENCE INTO lr_msg.
      ...
      temp130 = |<li>{ c_escape_html( lr_msg->text ) }</li>|.
      INSERT temp130 INTO TABLE lt_detail_items.
    ENDLOOP.
  ...
  METHOD data_render_tab.
    ...
    FIELD-SYMBOLS <tab> TYPE ANY TABLE.
    FIELD-SYMBOLS <row> TYPE ANY.
        DATA temp131 LIKE LINE OF lt_item.
      DATA temp132 LIKE LINE OF lt_item.
    ...
    LOOP AT <tab> ASSIGNING <row>.
      ...
      IF lv_no > cv_data_max_rows.
        ...
        temp131 = |<li><em>... { lines( <tab> ) - cv_data_max_rows } more entries</em></li>|.
        INSERT temp131
               INTO TABLE lt_item.
        EXIT.
      ENDIF.

      temp132 = |<li>{ data_render( val = <row> depth = depth + 1 ) }</li>|.
      INSERT temp132 INTO TABLE lt_item.
    ENDLOOP.
  ...
  METHOD data_render_struc.
    ...
    FIELD-SYMBOLS <comp> TYPE any.
        DATA lt_attri TYPE abap_component_tab.
    DATA temp133 LIKE LINE OF lt_attri.
  ...
  METHOD data_render_oref.
    ...
    FIELD-SYMBOLS <comp> TYPE any.
        DATA lt_attri TYPE abap_attrdescr_tab.
    DATA temp134 LIKE LINE OF lt_attri.
    DATA lr_attri LIKE REF TO temp134.
  ...
  METHOD data_get_exc_text.
        DATA temp135 TYPE REF TO cx_root.

    TRY.

        temp135 ?= val.
        result = temp135->get_text( ).
      CATCH cx_root ##NO_HANDLER.
  ...
  METHOD rtti_check_serializable.
        DATA temp136 TYPE REF TO if_serializable_object.
        DATA lo_dummy LIKE temp136.
...
DATA lt_impl TYPE temp2.
  ...
  METHOD msg_get_internal.
        FIELD-SYMBOLS <tab> TYPE ANY TABLE.
        DATA lt_attri TYPE abap_component_tab.
        DATA temp137 TYPE ty_s_msg.
        DATA ls_result LIKE temp137.
        DATA temp138 LIKE LINE OF lt_attri.
        DATA ls_attri LIKE REF TO temp138.
          FIELD-SYMBOLS <comp> TYPE any.
          DATA temp139 TYPE z2ui5_cl_ui5_util_context=>ty_s_msg.
    ...
    CASE rtti_get_type_kind( val ).
      ...
      WHEN OTHERS.
        ...
        IF rtti_check_clike( val ) IS NOT INITIAL AND val IS NOT INITIAL.
          ...
          CLEAR temp139.
          temp139-text = val.
          INSERT temp139 INTO TABLE result.
        ENDIF.
    ENDCASE.
  ...
  METHOD msg_get_by_oref.
        DATA temp140 TYPE REF TO cx_root.
        DATA lx LIKE temp140.
        DATA temp141 TYPE z2ui5_cl_ui5_util_context=>ty_s_msg.
    DATA obj TYPE REF TO object.
    DATA lr_tab TYPE REF TO data.
    FIELD-SYMBOLS <tab> TYPE any.
    DATA temp142 TYPE z2ui5_cl_ui5_util_context=>ty_s_msg.
    ...
    TRY.
        ...
        CLEAR temp141.
        temp141-type = `E`.
        temp141-text = lx->get_text( ).
        INSERT msg_get_by_oref_attri( io_obj = lx
                                      is_msg = temp141 ) INTO TABLE result.
        RETURN.
      CATCH cx_root ##NO_HANDLER.
    ENDTRY.
    ...
    INSERT msg_get_by_oref_attri( io_obj = obj
                                  is_msg = temp142 ) INTO TABLE result.
  ...
  METHOD msg_get_by_oref_attri.
    ...
    DATA temp143 LIKE LINE OF lt_attri_o.
    DATA ls_attri_o LIKE REF TO temp143.
  ...
  METHOD check_is_rap_struct.
    ...
    DATA lt_attri TYPE abap_component_tab.
    DATA temp144 LIKE LINE OF lt_attri.
    DATA ls_attri LIKE REF TO temp144.
          ...
          DATA temp147 LIKE LINE OF lt_comps.
          DATA ls_comp LIKE REF TO temp147.
    lt_attri = rtti_get_t_attri_by_any( val ).
    ...
    LOOP AT lt_attri REFERENCE INTO ls_attri.
      ...
      TRY.
          ...
          temp145 ?= ls_attri->type.

          lo_line = temp145->get_table_line_type( ).
          CHECK lo_line->kind = cl_abap_typedescr=>kind_struct.

          temp146 ?= lo_line.

          lt_comps = temp146->get_components( ).
  ...
  METHOD msg_get_rap.
    ...
    DATA lt_attri TYPE abap_component_tab.
    DATA temp148 LIKE LINE OF lt_attri.
    DATA ls_attri LIKE REF TO temp148.
      FIELD-SYMBOLS <tab> TYPE any.
      FIELD-SYMBOLS <ftab> TYPE ANY TABLE.
      DATA temp149 TYPE REF TO cl_abap_tabledescr.
      DATA lo_line TYPE REF TO cl_abap_datadescr.
      FIELD-SYMBOLS <row> TYPE ANY.
    ...
    LOOP AT lt_attri REFERENCE INTO ls_attri.
      ...
      temp149 ?= ls_attri->type.

      lo_line = temp149->get_table_line_type( ).
  ...
  METHOD msg_get_rap_row.
    ...
    FIELD-SYMBOLS <fail> TYPE any.
      FIELD-SYMBOLS <cause> TYPE any.
        ...
        DATA temp150 TYPE z2ui5_cl_ui5_util_context=>ty_s_msg.
    ...
    IF sy-subrc = 0.
      ...
      IF sy-subrc = 0.
        ...
        CLEAR temp150.
        temp150-type = `E`.
        temp150-text = lv_text.
        temp150-t_meta = lt_meta.
        INSERT temp150 INTO TABLE messages.
      ENDIF.
    ENDIF.
  ...
  METHOD scan_flag_prefix.
    ...
    DATA lv_len TYPE i.
    DATA lt_attri TYPE abap_component_tab.
    DATA temp151 LIKE LINE OF lt_attri.
    DATA ls_attri LIKE REF TO temp151.
  ...
  METHOD msg_get_rap_action.
    ...
    READ TABLE lt_suffix INTO temp153 INDEX 1.
    IF sy-subrc = 0.
      temp152 = temp153.
    ENDIF.
    result = temp152.
  ...
  METHOD msg_get_rap_flatten.
    ...
    DATA temp154 LIKE LINE OF lt_attri.
    DATA ls_attri LIKE REF TO temp154.
      FIELD-SYMBOLS <comp> TYPE any.
      DATA lv_sub_kind TYPE string.
        DATA lv_sub TYPE string.
            DATA lv_str TYPE string.
            DATA temp155 LIKE LINE OF lt_part.
    lv_kind = rtti_get_type_kind( val ).
    IF lv_kind <> cl_abap_datadescr=>typekind_struct1
        AND lv_kind <> cl_abap_datadescr=>typekind_struct2.
      RETURN.
    ...
    LOOP AT lt_attri REFERENCE INTO ls_attri.
      ...
      ELSEIF <comp> IS NOT INITIAL AND rtti_check_printable( <comp> ) = abap_true.
        ...
        TRY.
            ...
            temp155 = |{ ls_attri->name }={ lv_str }|.
            APPEND temp155 TO lt_part.
          CATCH cx_root ##NO_HANDLER.
        ENDTRY.
      ENDIF.
    ENDLOOP.
  ...
  METHOD msg_get_rap_meta.
    ...
    DATA lv TYPE string.
      DATA temp156 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
      DATA temp157 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
      DATA temp158 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
      DATA temp159 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
      DATA temp160 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
      DATA temp161 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    ...
    IF lv IS NOT INITIAL.
      ...
      temp156-n = `element`.
      temp156-v = lv.
      INSERT temp156 INTO TABLE result.
    ENDIF.
    ...
    IF lv IS NOT INITIAL.
      ...
      CLEAR temp157.
      temp157-n = `state_area`.
      temp157-v = lv.
      INSERT temp157 INTO TABLE result.
    ENDIF.
    ...
    IF lv IS NOT INITIAL.
      ...
      temp158-n = `action`.
      temp158-v = lv.
      INSERT temp158 INTO TABLE result.
    ENDIF.
    ...
    IF lv IS NOT INITIAL.
      ...
      temp159-n = `pid`.
      temp159-v = lv.
      INSERT temp159 INTO TABLE result.
    ENDIF.
    ...
    IF lv IS NOT INITIAL.
      ...
      temp160-n = `cid`.
      temp160-v = lv.
      INSERT temp160 INTO TABLE result.
    ENDIF.
    ...
    IF lv IS NOT INITIAL.
      ...
      temp161-n = `tky`.
      temp161-v = lv.
      INSERT temp161 INTO TABLE result.
    ENDIF.
  ...
  METHOD msg_get_rap_fail_text.
    ...
    CASE cause.
      WHEN 0.
        temp162 = `Operation failed`.
      WHEN 1.
        temp162 = `Entity not found`.
      WHEN 2.
        temp162 = `Entity is locked`.
      WHEN 3.
        temp162 = `Authorization failure`.
      WHEN 4 OR 5.
        temp162 = `Concurrent modification`.
      WHEN 6.
        temp162 = `Operation disabled`.
      WHEN 7.
        temp162 = `Operation forbidden`.
      WHEN 8.
        temp162 = `Semantic error`.
      WHEN 9.
        temp162 = `Determination failed`.
      WHEN 10.
        temp162 = `Permission denied`.
      WHEN 11.
        temp162 = `Validation failed`.
      WHEN OTHERS.
        temp162 = |Operation failed (cause code { cause })|.
    ENDCASE.
    result = temp162.
