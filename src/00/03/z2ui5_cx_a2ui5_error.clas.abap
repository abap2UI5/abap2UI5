...
CLASS z2ui5_cx_a2ui5_error IMPLEMENTATION.
    ...
    WHILE lo_x IS BOUND AND lv_count < cv_chain_max.
      ...
      IF lv_text IS NOT INITIAL AND lv_text <> lv_last.
        ...
        IF result IS INITIAL.
          temp3 = lv_text.
        ELSE.
          temp3 = result && z2ui5_cl_a2ui5_context=>cv_char_util_newline && lv_text.
        ENDIF.
        result = temp3.
        lv_last = lv_text.
      ENDIF.
  ...
  METHOD get_text_full_entry.
    ...
    DATA lt_attri TYPE z2ui5_cl_a2ui5_context=>ty_t_name_value.
    ...
    lv_position = z2ui5_cl_a2ui5_context=>error_get_source_position( val ).
    ...
    lt_attri = z2ui5_cl_a2ui5_context=>error_get_attributes( val ).
