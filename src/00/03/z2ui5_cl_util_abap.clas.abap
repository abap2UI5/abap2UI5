...
*    temp10 ?= cl_abap_structdescr=>describe_by_name( 'TY_S_DFIES' ).
  ...
  METHOD rtti_get_t_attri_on_cloud.
    ...
    DATA lr_comp LIKE REF TO temp2.
      ...
      DATA temp4 TYPE z2ui5_cl_util_abap=>ty_s_dfies.
...
*    ENDLOOP.
  ...
  METHOD bus_search_help_read.
    ...
    DATA interface LIKE LINE OF ms_shlp-interface.
        DATA temp6 TYPE z2ui5_cl_util_abap=>ty_shlp_descr-selopt.
        DATA temp7 LIKE LINE OF temp6.
        DATA temp1 TYPE z2ui5_cl_util_abap=>ty_ddshselopt-option.
    DATA fieldrop LIKE LINE OF ms_shlp-fieldprop.
      DATA valule LIKE fieldrop-defaultval.
      DATA temp8 TYPE z2ui5_cl_util_abap=>ty_shlp_descr-selopt.
      DATA temp9 LIKE LINE OF temp8.
      DATA temp2 TYPE z2ui5_cl_util_abap=>ty_ddshselopt-option.
    DATA field_props LIKE LINE OF ms_shlp-fieldprop.
      DATA temp10 TYPE z2ui5_cl_util_abap=>ty_s_dfies_2.
      DATA temp11 TYPE z2ui5_cl_util_abap=>ty_s_dfies_2.
