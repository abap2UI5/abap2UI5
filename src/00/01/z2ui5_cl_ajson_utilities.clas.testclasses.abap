...
CLASS ltcl_json_utils DEFINITION
  ...
  PRIVATE SECTION.
    ...
    METHODS iterate_array FOR TESTING RAISING z2ui5_cx_ajson_error.
    METHODS iterate_object FOR TESTING RAISING z2ui5_cx_ajson_error.
...
*      '        "row": 4,\n' && " array delete
  ...
  METHOD iterate_array.
    ...
    TRY.
        z2ui5_cl_ajson_utilities=>iterate_array(
        ii_json = li_cut
        iv_path = '/notexisting' ).
  ...
  METHOD iterate_object.
    ...
    TRY.
        z2ui5_cl_ajson_utilities=>iterate_object(
        ii_json = li_cut
        iv_path = '/notexisting' ).
        cl_abap_unit_assert=>fail( ).
      CATCH z2ui5_cx_ajson_error INTO lx.
