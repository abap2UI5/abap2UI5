...
CLASS ltcl_integration_test IMPLEMENTATION.
  ...
  METHOD test_xml_view.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = ``.
  ...
  METHOD test_bind_one_way.
    ...
    DATA(lo_test) = NEW z2ui5_tcl_fw_integration_test( ) ##NEEDED.

    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_ONE_WAY`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
  ...
  METHOD test_message_box.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_MESSAGE_BOX`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
  ...
  METHOD test_message_toast.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_MESSAGE_TOAST`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
  ...
  METHOD test_timer.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_TIMER`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
  ...
  METHOD test_xml_popup.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_POPUP`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
...
*    ENDIF.
  ...
  METHOD test_scroll_cursor.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_SCROLL_CURSOR`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
  ...
  METHOD test_startup_path.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `TEST_NAVIGATE`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post(
      `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
...
*        exp                  = `tomato 700 - send to the server` ).
  ...
  METHOD test_app_dump.
    ...
    z2ui5_tcl_fw_integration_test=>sv_state = `ERROR`.
    DATA(lv_response) = z2ui5_cl_fw_http_handler=>http_post( `{ "OLOCATION" : { "SEARCH" : "app_start=z2ui5_cl_fw_integration_test"}}` ).
