...
CLASS ltcl_test_roundtrip IMPLEMENTATION.
  ...
  METHOD test_init_displays_popup.
    ...
    DATA(lo_pop) = z2ui5_cl_pop_demo_output=>factory( i_output = NEW z2ui5_cl_abap2ui5_error( `x` )
                                                      i_title  = `Demo Title` ).
  ...
  METHOD test_toggle_fullscreen.
    ...
    DATA(lo_pop) = z2ui5_cl_pop_demo_output=>factory( NEW z2ui5_cl_abap2ui5_error( `x` ) ).
