...
CLASS z2ui5_cl_pop_to_select IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    ELSEIF i_multiselect = abap_true.
      temp13 = `Multi Select`.
    ELSE.
      temp13 = `Single Select`.
    ENDIF.
    r_result->title = temp13.
  ...
  METHOD set_output_table.
    ...
    DATA lo_table LIKE temp17.
        DATA temp18 TYPE REF TO cl_abap_structdescr.
        DATA lo_struct LIKE temp18.
        DATA lt_comp TYPE abap_component_tab.
        DATA temp19 TYPE REF TO cl_abap_elemdescr.
        DATA lo_elem LIKE temp19.
    ...
    DATA temp21 LIKE sy-subrc.
      ...
      DATA temp22 TYPE abap_componentdescr.
