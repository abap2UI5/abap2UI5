...
CLASS z2ui5_cl_pop_to_select IMPLEMENTATION.
  ...
  METHOD display.
    ...
    DATA columns TYPE REF TO z2ui5_cl_xml_view.
      ...
      DATA temp3 TYPE z2ui5_cl_util_api=>ty_s_data_element_text-medium.
      DATA data_element_name TYPE string.
      DATA medium_label TYPE z2ui5_cl_util_api=>ty_s_data_element_text-medium.
    ...
    INSERT `${$parameters>/clearButtonPressed}` INTO TABLE temp10.
    ...
    LOOP AT lt_comp INTO ls_comp.
      ...
      data_element_name = substring_after( val = temp12->absolute_name sub = `\TYPE=` ).
  ...
  METHOD set_output_table.
    ...
    TRY.
        ...
        temp14 ?= lo_table->get_table_line_type( ).
      ...
      CATCH cx_root.
        ...
        temp15 ?= lo_table->get_table_line_type( ).
        
        lo_elem = temp15.
        
        CLEAR temp16.
        temp16-name = `TAB_LINE`.
