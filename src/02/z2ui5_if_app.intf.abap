INTERFACE z2ui5_if_app PUBLIC.
  ...
  "! id_app is the id nav_app_call( ) / nav_app_leave( ) return for the
  "! instance they were handed, minted once per instance so two hops to the
  "! same object answer the same id. Both are written at moments when no
  "! wrapper exists yet - an app handed to nav_app_call( ), a draft looked up
  "! before it is parsed. They are public only because an ABAP interface has
  "! no protected section; an app neither sets nor reads them.
