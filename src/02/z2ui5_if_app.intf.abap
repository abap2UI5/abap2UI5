INTERFACE z2ui5_if_app PUBLIC.
  ...
  "! own app wrapper (z2ui5_cl_ui5_app) the way the two flags below did: it
  "! is the HANDLE that maps an app reference back to its draft, and
  "! therefore back to that wrapper - z2ui5_cl_ui5_app=>db_load_by_app( )
  ...
  "! obsolete - moved to z2ui5_cl_ui5_app=>mv_check_initialized, which is
  ...
  "! obsolete - moved to z2ui5_cl_ui5_app=>mv_check_sticky, which is where
