...
CLASS z2ui5_cl_ui5_view_builder IMPLEMENTATION.
  ...
  METHOD a.
    DATA val LIKE v.
      ...
      DATA temp3 TYPE z2ui5_cl_ui5_view_builder=>ty_s_pair.
      DATA target LIKE LINE OF t_child.
      DATA temp6 LIKE LINE OF t_child.
      DATA temp7 LIKE sy-tabix.
      DATA temp4 LIKE sy-subrc.
      DATA temp5 TYPE z2ui5_cl_ui5_view_builder=>ty_s_pair.
    ...
    ELSE.
      ...
      temp7 = sy-tabix.
      READ TABLE t_child INDEX lines( t_child ) INTO temp6.
      sy-tabix = temp7.
      IF sy-subrc <> 0.
        ASSERT 1 = 0.
      ENDIF.
