...
CLASS z2ui5_cl_http_handler IMPLEMENTATION.
  ...
  METHOD main.
        DATA temp1 TYPE z2ui5_if_types=>ty_s_http_config_post.
    ...
    CASE ms_req-method.
      ...
      WHEN `POST`.
        ...
        IF _check_csrf_rejected( active  = ls_config_post-check_csrf_active
          ...
          CLEAR ms_res.
          ms_res-body = `CSRF validation failed - cross-origin POST rejected`.
  ...
  METHOD _http_get.
    ...
    IF ls_config-styles_css IS INITIAL.
      temp3 = z2ui5_cl_app_style_css=>get( ).
    ELSE.
    ...
    lv_preload = z2ui5_cl_app_preload=>get( styles_css = lv_style_css
  ...
  METHOD _http_post.
    ...
    TRY.
        ...
        temp6 ?= lo_post->mo_action->mo_app->mo_app.
  ...
  METHOD _main.
        ...
        DATA temp7 TYPE z2ui5_if_types=>ty_s_http_config_post.
        DATA ls_config_post LIKE temp7.
        DATA temp1 TYPE z2ui5_if_core_types=>ty_s_http_res-body.
    ...
    TRY.
      ...
      CATCH cx_root INTO lx.
        ...
        IF ls_config_post-check_hide_error_details = abap_true.
          temp1 = `Internal Server Error`.
        ELSE.
          temp1 = _error_body( val = lx method = is_req-method ).
        ENDIF.
        result-body = temp1.
