...
CLASS z2ui5_cl_xml_view_cc IMPLEMENTATION.
  ...
  METHOD websocket.
    ...
    temp42-v = z2ui5_cl_util=>boolean_abap_2_json( checkactive ).
    INSERT temp42 INTO TABLE temp41.
    temp42-n = `checkRepeat`.
    temp42-v = z2ui5_cl_util=>boolean_abap_2_json( checkrepeat ).
    INSERT temp42 INTO TABLE temp41.
  ...
  METHOD lp_title.
    ...
    temp44-v = z2ui5_cl_util=>boolean_abap_2_json( applicationfullwidth ).
    INSERT temp44 INTO TABLE temp43.
    mo_view->_generic(
        name   = `LPTitle`
        ns     = `z2ui5`
  ...
  METHOD dirty.
    ...
    temp48-n = `isDirty`.
    temp48-v = z2ui5_cl_util=>boolean_abap_2_json( isdirty ).
