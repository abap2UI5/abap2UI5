CLASS z2ui5_cl_ui5_ui_layout DEFINITION
  PUBLIC
  FINAL
  ...
  PUBLIC SECTION.
    METHODS simpleform
      ...
      RETURNING VALUE(result) TYPE REF TO z2ui5_cl_ui5_ui_layout.

    METHODS content
      IMPORTING
        ns            TYPE clike DEFAULT `sap.ui.layout.form`
      RETURNING
        VALUE(result) TYPE REF TO z2ui5_cl_ui5_ui_layout.
...
CLASS z2ui5_cl_ui5_ui_layout IMPLEMENTATION.
