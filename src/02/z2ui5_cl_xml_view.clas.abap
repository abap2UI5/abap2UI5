...
*              ns     = `webc`
  ...
  METHOD xml_get.
    ...
    DATA lt_prop TYPE HASHED TABLE OF z2ui5_if_types=>ty_s_name_value WITH UNIQUE KEY n.
      ...
      DATA lr_ns LIKE REF TO temp555.
            ...
            DATA temp2 LIKE LINE OF lt_prop.
    ...
    IF me = mo_root.
      ...
      LOOP AT mt_ns REFERENCE INTO lr_ns WHERE table_line IS NOT INITIAL  "#EC CI_SORTSEQ
        ...
        TRY.
            ...
            temp3 = sy-tabix.
            READ TABLE lt_prop WITH KEY n = lr_ns->* INTO temp2.
            sy-tabix = temp3.
            IF sy-subrc <> 0.
              ASSERT 1 = 0.
            ENDIF.
  ...
  METHOD row_settings.
    ...
    temp623-n = `highlightText`.
    temp623-v = highlighttext.
    INSERT temp623 INTO TABLE temp622.
    temp623-n = `navigated`.
    temp623-v = z2ui5_cl_util=>boolean_abap_2_json( navigated ).
    INSERT temp623 INTO TABLE temp622.
    result = _generic(
                 name   = `RowSettings`
                 ns     = `table`
  ...
  METHOD image_editor.
    ...
    temp625-n = `customShapeSrc`.
    temp625-v = customshapesrc.
    INSERT temp625 INTO TABLE temp624.
    temp625-n = `keepCropAspectRatio`.
    temp625-v = z2ui5_cl_util=>boolean_abap_2_json( keepcropaspectratio ).
    INSERT temp625 INTO TABLE temp624.
    temp625-n = `keepResizeAspectRatio`.
    temp625-v = z2ui5_cl_util=>boolean_abap_2_json( keepresizeaspectratio ).
    INSERT temp625 INTO TABLE temp624.
    temp625-n = `scaleCropArea`.
    temp625-v = scalecroparea.
    INSERT temp625 INTO TABLE temp624.
    temp625-n = `customShapeSrcType`.
    temp625-v = customshapesrctype.
    INSERT temp625 INTO TABLE temp624.
    temp625-n = `src`.
    temp625-v = src.
    INSERT temp625 INTO TABLE temp624.
  ...
  METHOD image_editor_container.
    ...
    temp627-n = `enabledButtons`.
    temp627-v = enabledbuttons.
    INSERT temp627 INTO TABLE temp626.
    temp627-n = `mode`.
    temp627-v = mode.
    INSERT temp627 INTO TABLE temp626.
