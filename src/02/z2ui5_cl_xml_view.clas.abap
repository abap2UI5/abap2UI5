...
CLASS z2ui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD input.
    ...
    INSERT temp220 INTO TABLE temp219.
    temp220-n = `showValueStateMessage`.
    temp220-v = z2ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ).
    INSERT temp220 INTO TABLE temp219.
    _generic(
        name   = `Input`
        t_prop = temp219 ).
  ...
  METHOD progress_indicator.
    ...
    temp377-v = z2ui5_cl_util=>boolean_abap_2_json( displayonly ).
    INSERT temp377 INTO TABLE temp376.
    temp377-n = `displayAnimation`.
    temp377-v = z2ui5_cl_util=>boolean_abap_2_json( displayanimation ).
    INSERT temp377 INTO TABLE temp376.
  ...
  METHOD table.
    ...
    INSERT temp470 INTO TABLE temp469.
    temp470-n = `footerText`.
    temp470-v = footertext.
    INSERT temp470 INTO TABLE temp469.
    temp470-n = `multiSelectMode`.
    temp470-v = multiselectmode.
    INSERT temp470 INTO TABLE temp469.
    temp470-n = `keyboardMode`.
    temp470-v = keyboardmode.
    INSERT temp470 INTO TABLE temp469.
    temp470-n = `contextualWidth`.
    temp470-v = contextualwidth.
    INSERT temp470 INTO TABLE temp469.
    temp470-n = `rememberSelections`.
    temp470-v = z2ui5_cl_util=>boolean_abap_2_json( rememberselections ).
    INSERT temp470 INTO TABLE temp469.
    result = _generic( name   = `Table`
                       t_prop = temp469 ).
  ENDMETHOD.
