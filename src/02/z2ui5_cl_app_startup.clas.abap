...
CLASS z2ui5_cl_app_startup IMPLEMENTATION.
  ...
  METHOD view_display_start.
    ...
    IF z2ui5_cl_util=>rtti_check_class_exists( `z2ui5_cl_app_icf_config` ) IS NOT INITIAL.
    ...
    simple_form = create_layout_form( page ).
    ...
    lv_url_samples = get_app_url( `z2ui5_cl_demo_app_000` ).
...
MOVE-CORRESPONDING <class> TO ms_home.
  ...
  METHOD view_display_popup.
    ...
    simple_form2 = create_layout_form( content ).
