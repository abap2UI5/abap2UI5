...
CLASS ltcl_test_http_response IMPLEMENTATION.
  ...
  METHOD test_etag_after_304_of_other.
    ...
    DATA temp17 TYPE z2ui5_cl_ui5_http_handler=>ty_s_http_res.
    DATA ls_res_b LIKE temp17.
    CLEAR temp16.
  ...
  METHOD test_get_stale_tag_builds.
    ...
    DATA temp19 TYPE z2ui5_if_ui5_exit=>ty_s_http_config.
    DATA ls_config LIKE temp19.
    DATA ls_res TYPE z2ui5_cl_ui5_http_handler=>ty_s_http_res.
    CLEAR temp19.
    temp19-theme = `sap_horizon`.
    temp19-src = `https://sdk.example/sap-ui-core.js`.
  ...
  METHOD test_get_304_end_to_end.
    ...
    CLEAR temp20.
    temp20-n = `if-none-match`.
    temp20-v = lv_tag.
    INSERT temp20 INTO TABLE mo_mock->mt_req_header.
