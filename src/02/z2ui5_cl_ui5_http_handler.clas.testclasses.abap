...
CLASS ltcl_test_http_handler IMPLEMENTATION.
  ...
  METHOD test_main_get_routing.
    ...
    temp10 = boolc( ls_result-body CS `<!DOCTYPE html>` ).
    temp8 = temp10.
