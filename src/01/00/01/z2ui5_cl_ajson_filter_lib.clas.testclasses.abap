...
CLASS ltcl_filters_test IMPLEMENTATION.
  METHOD empty_filter_simple.
    ...
    li_json->set( iv_path = '/a'
                  iv_val  = '1' ).
    li_json->set( iv_path = '/b'
                  iv_val  = '' ).
    li_json->set( iv_path = '/c'
                  iv_val  = '3' ).
    li_json->set( iv_path = '/d'
                  iv_val  = 0 ).
    ...
    cl_abap_unit_assert=>assert_equals( exp = '{"a":"1","c":"3"}'
  ...
  METHOD empty_filter_deep.
    ...
    li_json->set( iv_path = '/a'
                  iv_val  = '1' ).
    li_json->set( iv_path = '/b/c'
                  iv_val  = '' ).
    li_json->set( iv_path = '/b/d'
                  iv_val  = 0 ).
    li_json->set( iv_path = '/d/e'
                  iv_val  = 0 ).
  ...
  METHOD path_filter.
    ...
    cl_abap_unit_assert=>assert_equals( exp = '{"a":"1","b":{},"c":{"d":"3"}}'
                                        act = li_json_filtered->stringify( ) ).
  ...
  METHOD path_filter_string.
    ...
    cl_abap_unit_assert=>assert_equals( exp = '{"a":"1","b":{},"c":{}}'
                                        act = li_json_filtered->stringify( ) ).
  ...
  METHOD path_filter_w_patterns.
    ...
    li_json->set( iv_path = '/c/d'
                  iv_val  = '3' ).
    li_json->set( iv_path = '/c/@meta2'
                  iv_val  = 'meta2' ).

    li_json_filtered = z2ui5_cl_ajson=>create_from( ii_source_json = li_json
  ...
  METHOD path_filter_deep.
    ...
    cl_abap_unit_assert=>assert_equals( exp = '{"a":"1","c":{"d":"3"}}'
                                        act = li_json_filtered->stringify( ) ).
