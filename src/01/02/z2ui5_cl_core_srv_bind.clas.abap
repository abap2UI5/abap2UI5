...
CLASS z2ui5_cl_core_srv_bind IMPLEMENTATION.
  ...
  METHOD main_cell.
    ...
    DATA temp28 TYPE z2ui5_if_core_types=>ty_s_bind_config.
  ...
  METHOD main_local.
    ...
    TRY.
        ...
        CLEAR temp30.
        temp30-name_client = |/{ lv_id }|.
        temp30-name = lv_id.
        temp30-json_bind_local = lo_json.
        temp30-bind_type = z2ui5_if_core_types=>cs_bind_type-one_time.
        INSERT temp30
  ...
  METHOD update_model_attri.
    DATA temp31 TYPE z2ui5_if_core_types=>ty_s_attri-view.
    ...
    IF ms_config-view IS INITIAL.
      temp31 = z2ui5_if_client=>cs_view-main.
    ELSE.
      temp31 = ms_config-view.
    ENDIF.
    mr_attri->view               = temp31.
