...
CLASS z2ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~get.
    ...
    DATA temp4 TYPE xsdboolean.
        ...
        DATA temp27 LIKE LINE OF lo_params->mt_json_tree.
        DATA lr_comp LIKE REF TO temp27.
          DATA temp28 TYPE z2ui5_if_types=>ty_s_name_value.
    ...
    TRY.
        ...
        LOOP AT lo_params->mt_json_tree                 "#EC CI_SORTSEQ
          ...
          CLEAR temp28.
          temp28-n = shift_left( val = shift_right( val = lr_comp->path sub = `/` ) sub = `/` ).
          temp28-v = lr_comp->value.
          INSERT temp28 INTO TABLE result-t_comp_params.
        ENDLOOP.
  ...
  METHOD z2ui5_if_client~get_event_arg.
        DATA temp29 LIKE LINE OF mo_action->ms_actual-t_event_arg.
    ...
    TRY.
        ...
        temp30 = sy-tabix.
        READ TABLE mo_action->ms_actual-t_event_arg INDEX v INTO temp29.
        sy-tabix = temp30.
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
  ...
  METHOD z2ui5_if_client~get_app.
      ...
      DATA temp31 TYPE REF TO z2ui5_if_app.

    IF id IS NOT INITIAL.

      lo_app = z2ui5_cl_core_app=>db_load( id ).

      temp31 ?= lo_app->mo_app.
      result = temp31.
    ELSE.
      result = get_if_app( ).
    ENDIF.
  ...
  METHOD z2ui5_if_client~_bind.
    ...
    DATA temp33 TYPE z2ui5_if_core_types=>ty_s_bind_config.
    CLEAR temp33.
    temp33-path_only = path.
    temp33-custom_filter = custom_filter.
    temp33-custom_mapper = custom_mapper.
    temp33-tab = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( tab ).
    temp33-tab_index = tab_index.
    temp33-switch_default_model = switch_default_model.
  ...
  METHOD z2ui5_if_client~_bind_edit.
    ...
    DATA temp34 TYPE z2ui5_if_core_types=>ty_s_bind_config.
    CLEAR temp34.
    temp34-path_only = path.
    temp34-custom_filter = custom_filter.
    temp34-custom_filter_back = custom_filter_back.
    temp34-custom_mapper = custom_mapper.
    temp34-custom_mapper_back = custom_mapper_back.
    temp34-tab = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( tab ).
    temp34-tab_index = tab_index.
    temp34-switch_default_model = switch_default_model.
    result = mo_srv_bind->main( val = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( val )
                            config  = temp34 ).
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    ...
    DATA temp35 TYPE z2ui5_if_core_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp35 = 0.
    ENDIF.
    mo_action->ms_next-s_set-s_stateful-active = temp35.
  ...
  METHOD get_if_app.
    ...
    DATA temp36 TYPE REF TO z2ui5_if_app.
    temp36 ?= mo_action->mo_app->mo_app.
    result = temp36.
