...
CLASS z2ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~_bind_edit.
    ...
    temp14-custom_filter_back = custom_filter_back.
    temp14-custom_mapper = custom_mapper.
    temp14-custom_mapper_back = custom_mapper_back.
    temp14-tab = z2ui5_cl_util=>conv_get_as_data_ref( tab ).
    temp14-tab_index = tab_index.
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    ...
    DATA temp15 TYPE z2ui5_if_core_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp15 = 0.
    ENDIF.
    mo_action->ms_next-s_set-s_stateful-active = temp15.
