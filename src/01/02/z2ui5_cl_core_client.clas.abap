...
CLASS z2ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    ...
    temp1 = boolc( mo_action->ms_next-s_set-s_stateful-switched = abap_false ).
    mo_action->ms_next-s_set-s_stateful-switched = temp1.
  ...
  METHOD z2ui5_if_client~check_on_init.
    ...
    temp3 = boolc( temp17->check_initialized = abap_false ).
    result = temp3.
