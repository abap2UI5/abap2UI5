...
CLASS z2ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~get.
    ...
    DATA temp4 TYPE xsdboolean.
        ...
        DATA temp23 LIKE LINE OF lo_params->mt_json_tree.
        DATA lr_comp LIKE REF TO temp23.
          DATA temp24 TYPE z2ui5_if_types=>ty_s_name_value.
    ...
    TRY.
        ...
        LOOP AT lo_params->mt_json_tree                 "#EC CI_SORTSEQ
          ...
          CLEAR temp24.
          temp24-n = shift_left( val = shift_right( val = lr_comp->path sub = `/` ) sub = `/` ).
          temp24-v = lr_comp->value.
          INSERT temp24 INTO TABLE result-t_comp_params.
        ENDLOOP.
  ...
  METHOD z2ui5_if_client~get_event_arg.
        DATA temp25 LIKE LINE OF mo_action->ms_actual-t_event_arg.
    ...
    TRY.
        ...
        temp26 = sy-tabix.
        READ TABLE mo_action->ms_actual-t_event_arg INDEX v INTO temp25.
        sy-tabix = temp26.
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
  ...
  METHOD z2ui5_if_client~get_app.
      ...
      DATA temp27 TYPE REF TO z2ui5_if_app.

    IF id IS NOT INITIAL.

      lo_app = z2ui5_cl_core_app=>db_load( id ).

      temp27 ?= lo_app->mo_app.
      result = temp27.
    ELSE.
      result = get_if_app( ).
    ENDIF.
  ...
  METHOD z2ui5_if_client~_bind.
    ...
    CLEAR temp29.
    temp29-path_only = path.
    temp29-custom_filter = custom_filter.
    temp29-custom_filter_back = custom_filter_back.
    temp29-custom_mapper = custom_mapper.
    temp29-custom_mapper_back = custom_mapper_back.
    temp29-tab = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( tab ).
    temp29-tab_index = tab_index.
    temp29-switch_default_model = switch_default_model.
...
*                                              switch_default_model = switch_default_model ) ).
  ...
  METHOD z2ui5_if_client~_bind_edit.
    ...
    DATA temp30 TYPE z2ui5_if_core_types=>ty_s_bind_config.
    CLEAR temp30.
    temp30-path_only = path.
    temp30-custom_filter = custom_filter.
    temp30-custom_filter_back = custom_filter_back.
    temp30-custom_mapper = custom_mapper.
    temp30-custom_mapper_back = custom_mapper_back.
    temp30-tab = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( tab ).
    temp30-tab_index = tab_index.
    temp30-switch_default_model = switch_default_model.
    result = mo_srv_bind->main( val = z2ui5_cl_a2ui5_context=>conv_get_as_data_ref( val )
                            type    = z2ui5_if_core_types=>cs_bind_type-two_way
                            config  = temp30 ).
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    ...
    DATA temp31 TYPE z2ui5_if_core_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp31 = 0.
    ENDIF.
    mo_action->ms_next-s_set-s_stateful-active = temp31.
  ...
  METHOD get_if_app.
    ...
    temp32 ?= mo_action->mo_app->mo_app.
    result = temp32.
