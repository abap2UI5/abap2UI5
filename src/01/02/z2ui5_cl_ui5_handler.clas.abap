...
CLASS z2ui5_cl_ui5_handler IMPLEMENTATION.
  ...
  METHOD main_process.
    ...
    DATA temp39 TYPE REF TO z2ui5_if_client.
    DATA li_client LIKE temp39.
    DATA temp40 TYPE REF TO z2ui5_if_app.
    DATA li_app LIKE temp40.
    CREATE OBJECT temp39 TYPE z2ui5_cl_ui5_client EXPORTING ACTION = mo_action.

    li_client = temp39.

    temp40 ?= mo_action->mo_app->mo_app.
