...
CLASS z2ui5_cl_ui5_handler IMPLEMENTATION.
  ...
  METHOD main_begin.
      DATA temp51 TYPE REF TO z2ui5_cl_ui5_srv_draft.
    ...
    ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
      ...
      CREATE OBJECT temp51 TYPE z2ui5_cl_ui5_srv_draft.
      temp51->cleanup( ).
  ...
  METHOD actions_serialize.
    DATA temp52 LIKE LINE OF t_action.
    DATA lr_action LIKE REF TO temp52.
  ...
  METHOD main_process.
    ...
    DATA temp53 TYPE REF TO z2ui5_if_client.
    DATA li_client LIKE temp53.
    DATA temp54 TYPE REF TO z2ui5_if_app.
    DATA li_app LIKE temp54.
    CREATE OBJECT temp53 TYPE z2ui5_cl_ui5_client EXPORTING ACTION = mo_action.

    li_client = temp53.

    temp54 ?= mo_action->mo_app->mo_app.
