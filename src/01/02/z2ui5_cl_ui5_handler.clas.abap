...
CLASS z2ui5_cl_ui5_handler IMPLEMENTATION.
  ...
  METHOD request_parse_body.
    DATA temp40 TYPE REF TO z2ui5_if_ajson.
    DATA lo_ajson LIKE temp40.
    DATA temp41 TYPE string.
    DATA lv_root LIKE temp41.
    DATA lv_model_path TYPE string.
    DATA lv_front TYPE string.
    DATA lv_config TYPE string.
    temp40 ?= z2ui5_cl_ajson=>parse( val ).
  ...
  METHOD request_parse_event_args.
    ...
    DATA lv_arg_index TYPE i.
      ...
      DATA lv_node_type TYPE z2ui5_if_ajson_types=>ty_node_type.
          DATA temp42 LIKE LINE OF result.
    lv_arg_index = 1.
    DO.
      ...
      CASE lv_node_type.
        ...
        WHEN z2ui5_if_ajson_types=>node_type-boolean.
          ...
          temp42 = io_json->get_boolean( lv_arg_path ).
          APPEND temp42 TO result.
        WHEN OTHERS.
  ...
  METHOD app_get_url.
    ...
    DATA temp43 TYPE z2ui5_cl_ui5_util_context=>ty_s_name_value.
    DATA temp44 TYPE string.
    DATA lv_shell TYPE string.
    DATA temp45 TYPE string.
    DATA lv_hash LIKE temp45.
    lt_param = z2ui5_cl_ui5_util_context=>url_param_get_tab( search ).
    DELETE lt_param WHERE n = `app_start`.

    CLEAR temp43.
    temp43-n = `app_start`.
    temp43-v = to_lower( classname ).
    INSERT temp43 INTO TABLE lt_param.
    ...
    lv_shell = hash_get_shell_part( iv_hash             = temp44
  ...
  METHOD response_abap_to_json.
        ...
        DATA li_ajson_result LIKE temp46.
    ...
    TRY.
        ...
        temp46 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ajson_mapping=>create_upper_case( ) ).

        li_ajson_result = temp46.
        ...
        IF val-model IS INITIAL OR val-model = `{}`.
          temp47 = |\{"S_FRONT":{ lv_frontend }\}|.
        ELSE.
          temp47 = |\{"S_FRONT":{ lv_frontend },"MODEL":{ val-model }\}|.
        ENDIF.
        result = temp47.
  ...
  METHOD main_begin.
      DATA temp49 TYPE REF TO z2ui5_cl_ui5_srv_draft.
    ...
    ELSEIF ms_request-s_control-app_start IS NOT INITIAL.
      ...
      CREATE OBJECT temp49 TYPE z2ui5_cl_ui5_srv_draft.
      temp49->cleanup( ).
  ...
  METHOD actions_serialize.
    DATA temp50 LIKE LINE OF t_action.
    DATA lr_action LIKE REF TO temp50.
  ...
  METHOD main_process.
    ...
    DATA temp51 TYPE REF TO z2ui5_if_client.
    DATA li_client LIKE temp51.
    DATA temp52 TYPE REF TO z2ui5_if_app.
    DATA li_app LIKE temp52.
    CREATE OBJECT temp51 TYPE z2ui5_cl_ui5_client EXPORTING ACTION = mo_action.

    li_client = temp51.

    temp52 ?= mo_action->mo_app->mo_app.
