...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_stack_call_cross_class.
    ...
    FIELD-SYMBOLS <temp11> LIKE LINE OF lo_result->ms_next-t_action_front.
    ...
    temp12 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 ASSIGNING <temp11>.
    sy-tabix = temp12.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_stack_leave.
    ...
    FIELD-SYMBOLS <temp15> LIKE LINE OF lo_result->ms_next-t_action_front.
    ...
    temp16 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 ASSIGNING <temp15>.
    sy-tabix = temp16.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp18 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 2 ASSIGNING <temp17>.
    sy-tabix = temp18.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
