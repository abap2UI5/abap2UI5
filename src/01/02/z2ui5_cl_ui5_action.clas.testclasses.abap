...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD test_first_start_draft_gone.
    ...
    DATA lo_action TYPE REF TO z2ui5_cl_ui5_action.
    DATA lo_result TYPE REF TO z2ui5_cl_ui5_action.
    DATA temp1 LIKE LINE OF lo_result->ms_next-s_action-t_custom.
    ...
    temp2 = sy-tabix.
    READ TABLE lo_result->ms_next-s_action-t_custom INDEX 1 INTO temp1.
    sy-tabix = temp2.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_stack_call.
    ...
    DATA temp5 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp6 LIKE sy-tabix.
    DATA temp1 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp2 LIKE sy-tabix.
    DATA temp7 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp8 LIKE sy-tabix.
    DATA temp9 LIKE LINE OF lo_result->ms_next-t_action_front.
    ...
    temp6 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp5.
    sy-tabix = temp6.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp2 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp1.
    sy-tabix = temp2.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp8 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 2 INTO temp7.
    sy-tabix = temp8.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp10 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 2 INTO temp9.
    sy-tabix = temp10.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_stack_call_cross_class.
    ...
    DATA lo_action TYPE REF TO z2ui5_cl_ui5_action.
    DATA lo_result TYPE REF TO z2ui5_cl_ui5_action.
    DATA temp9 TYPE z2ui5_if_ui5_types=>ty_t_system_action.
    DATA temp10 LIKE LINE OF temp9.
    DATA temp11 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp12 LIKE sy-tabix.
    DATA temp13 LIKE LINE OF lo_result->ms_next-t_action_front.
    ...
    temp10-slot = z2ui5_if_client=>cs_view-main.
    temp10-method = z2ui5_if_ui5_types=>cs_slot_action-destroy.
    INSERT temp10 INTO TABLE temp9.
    temp10-slot = z2ui5_if_client=>cs_view-nested.
    temp10-method = z2ui5_if_ui5_types=>cs_slot_action-display.
    temp10-xml = `<Nest/>`.
    INSERT temp10 INTO TABLE temp9.
    lo_action->ms_next-t_action_front = temp9.
    ...
    temp12 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp11.
    sy-tabix = temp12.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp14 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp13.
    sy-tabix = temp14.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_stack_leave.
    ...
    DATA lo_result TYPE REF TO z2ui5_cl_ui5_action.
    DATA temp13 TYPE z2ui5_if_ui5_types=>ty_s_queued_action.
    DATA temp14 TYPE z2ui5_if_ui5_types=>ty_s_queued_action.
    DATA temp15 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp16 LIKE sy-tabix.
    DATA temp19 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp20 LIKE sy-tabix.
    DATA temp17 LIKE LINE OF lo_result->ms_next-t_action_front.
    DATA temp18 LIKE sy-tabix.
    DATA temp21 LIKE LINE OF lo_result->ms_next-t_action_front.
    ...
    CLEAR temp13.
    temp13-js = `some_js`.
    INSERT temp13 INTO TABLE lo_action->ms_next-s_action-t_custom.

    CLEAR temp14.
    temp14-js = `some_system_js`.
    INSERT temp14 INTO TABLE lo_action->ms_next-s_action-t_system.
    ...
    temp16 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp15.
    sy-tabix = temp16.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp20 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 1 INTO temp19.
    sy-tabix = temp20.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp18 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 2 INTO temp17.
    sy-tabix = temp18.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp22 = sy-tabix.
    READ TABLE lo_result->ms_next-t_action_front INDEX 2 INTO temp21.
    sy-tabix = temp22.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
  ...
  METHOD test_stack_leave_ancestor_gone.
    ...
    DATA temp19 TYPE z2ui5_cl_ui5_srv_draft=>ty_s_draft.
    DATA temp23 TYPE REF TO z2ui5_cl_ui5_srv_draft.
    ...
    CLEAR temp19.
    temp19-id = `LEAVE_ANCESTOR_DRAFT`.
    temp19-id_prev_app_stack = `LEAVE_GRANDPARENT`.

    CREATE OBJECT temp23 TYPE z2ui5_cl_ui5_srv_draft.
    temp23->create(
        draft     = temp19
        model_xml = `<dummy/>` ).
