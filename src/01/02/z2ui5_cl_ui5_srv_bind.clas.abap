...
CLASS z2ui5_cl_ui5_srv_bind IMPLEMENTATION.
  ...
  METHOD main_cell.
    ...
    DATA temp73 TYPE z2ui5_if_ui5_types=>ty_s_bind_config.
    CLEAR temp73.
    temp73-path_only = abap_true.
    temp73-custom_mapper = config-custom_mapper.
    temp73-custom_filter = config-custom_filter.
