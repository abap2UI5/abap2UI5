" OBSOLETE - covered by ltcl_02_db and ltcl_04_model, to be deleted once the mapping is checked:
"   test_instantiation/test_attri_initialized -> nothing_bound_is_empty (a fresh container)
"   test_buffer_clear -> load_buffered_per_request
...
" OBSOLETE - covered by ltcl_02_db and ltcl_04_model, to be deleted once the mapping is checked:
"   test_db_save/test_db_roundtrip -> save_then_load
"   test_db_save_complex -> save_marks_app, draft_fields_survive
"   test_model_stringify -> stringify_bound_rows_only
...
" OBSOLETE - covered by ltcl_01_xml, ltcl_02_db and ltcl_03_errors, to be deleted once the mapping is checked:
"   draft_roundtrip_shapes -> save_then_load, second_roundtrip_clean, change_between_drafts, dead_object_dropped
"   load_by_app_after_swap -> load_by_app_after_swap
"   load_broken_payload_loud -> broken_payload_bound_loud
...
" ===========================================================================
" THE STRUCTURED SUITE - one section per contract of the container, over
" the fixtures above (ltcl_cont_app with its helper, its dead object, its
" runtime-built table referenced three times; the two sub-app classes):
"
"   ltcl_00_base   fixture, a bind on the container, the load helpers
"   ltcl_01_xml    all_xml_stringify / all_xml_parse - the app as a document
"   ltcl_02_db     db_save / db_load / db_load_by_app - the draft table and
"                  the per-request buffer
"   ltcl_03_errors what a load that cannot restore says
"   ltcl_04_model  model_json_stringify / model_json_parse through the container
"
" The classes above this line carry an OBSOLETE note naming the section
" that covers them; they stay until that mapping has been checked.
" ===========================================================================
