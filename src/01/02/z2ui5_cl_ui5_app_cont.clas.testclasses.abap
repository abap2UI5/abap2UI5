...
bind( ir_val  = temp18
  ...
  METHOD parse_answers_refused.
    ...
    DATA temp19 LIKE REF TO mo_user->mt_std.
    DATA lo_front TYPE REF TO z2ui5_cl_ajson.
    DATA lt_skipped TYPE z2ui5_if_client=>ty_t_model_skip.
    FIELD-SYMBOLS <temp20> LIKE LINE OF lt_skipped.
...
bind( ir_val  = temp19
    ...
    temp21 = sy-tabix.
    READ TABLE lt_skipped INDEX 1 ASSIGNING <temp20>.
    sy-tabix = temp21.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp27 = sy-tabix.
    READ TABLE mo_user->mt_std INDEX 1 ASSIGNING <temp26>.
    sy-tabix = temp27.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
