...
*    ).
    ...
    DATA temp68 TYPE ltcl_test_app_root3=>ty_s_row.
    DATA temp69 LIKE REF TO mt_tab.
    CLEAR temp68.
    temp68-comp1 = 'comp1'.
    temp68-comp2 = 'comp2'.
    INSERT temp68 INTO TABLE mt_tab.

    
    GET REFERENCE OF mt_tab INTO temp69.
CREATE OBJECT mo_obj TYPE ltcl_test_app_root_attri3 EXPORTING ir_tab = temp69.
...
TYPES END OF ty_s_row.
    ...
    DATA temp71 TYPE z2ui5_if_core_types=>ty_t_attri.
    DATA lt_attri LIKE temp71.
    DATA temp72 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_core_srv_model.
    DATA ls_attri TYPE REF TO z2ui5_if_core_types=>ty_s_attri.
    DATA temp73 LIKE REF TO lt_attri.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_core_srv_model EXPORTING attri = temp72 app = lo_app.
    ...
    GET REFERENCE OF lt_attri INTO temp73.
CREATE OBJECT lo_model TYPE z2ui5_cl_core_srv_model EXPORTING attri = temp73 app = lo_app.
