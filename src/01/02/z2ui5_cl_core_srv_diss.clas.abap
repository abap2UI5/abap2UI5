...
DATA lt_init TYPE z2ui5_if_core_types=>ty_t_attri.
    ...
    GET REFERENCE OF mo_app INTO temp58.
...
ls_attri = temp4.
    ...
    GET REFERENCE OF ls_attri INTO temp59.

lt_init = diss_oref( temp59 ).
  ...
  METHOD main_run.
    ...
    DATA temp60 TYPE z2ui5_if_core_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp60.
    DATA temp61 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp61.
