...
CLASS z2ui5_cl_ui5_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_stringify.
        ...
        DATA ajson_result LIKE temp243.
        DATA temp244 TYPE REF TO z2ui5_if_ajson.
        DATA ajson_default LIKE temp244.
...
TYPES END OF ty_s_mapper_cache.
        ...
        DATA lr_attri LIKE REF TO temp245.
            DATA lr_mapper_cache TYPE REF TO ty_s_mapper_cache.
              ...
              DATA temp247 TYPE ty_s_mapper_cache.
              DATA lr_ref TYPE REF TO data.
          FIELD-SYMBOLS <val> TYPE data.
        DATA x TYPE REF TO cx_root.
    TRY.
        ...
        temp243 ?= z2ui5_cl_ajson=>create_empty( ).

        ajson_result = temp243.

        temp244 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ajson_mapping=>create_upper_case( ) ).

        ajson_default = temp244.
        ...
        LOOP AT mt_attri->* REFERENCE INTO lr_attri "#EC CI_SORTSEQ
          ...
          IF lr_attri->custom_mapper IS BOUND.
            ...
            ELSE.
              ...
              temp246 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = lr_attri->custom_mapper ).
              ajson = temp246.

              CLEAR temp247.
              temp247-mapper = lr_attri->custom_mapper.
              temp247-ajson = ajson.
              INSERT temp247 INTO TABLE lt_mapper_cache.
            ENDIF.
          ELSE.
            ajson = ajson_default.
          ENDIF.
  ...
  METHOD main_attri_db_load.
    ...
    DATA lr_pre LIKE REF TO temp248.
      DATA temp249 TYPE z2ui5_cl_ui5_srv_model=>ty_s_child_idx.
    ...
    LOOP AT mt_attri->* REFERENCE INTO lr_pre     "#EC CI_SORTSEQ
      ...
      CLEAR temp249.
      temp249-name_parent = lr_pre->name_parent.
      temp249-name = lr_pre->name.
      INSERT temp249 INTO TABLE lt_child_idx.
    ENDLOOP.
...
GET REFERENCE OF <parent_ref> INTO lr_ref_parent.
  ...
  METHOD main_attri_db_load_dref.
    ...
    FIELD-SYMBOLS <parent_ref> TYPE any.
    DATA temp252 LIKE LINE OF ir_child_idx->*.
    DATA lr_child_idx LIKE REF TO temp252.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    DATA lr_attri LIKE REF TO temp253.
      ...
      DATA lo_descr TYPE REF TO cl_abap_typedescr.
          DATA temp254 LIKE LINE OF mt_attri->*.
          DATA lr_attri_child LIKE REF TO temp254.
            DATA lv_path_child TYPE string.
            FIELD-SYMBOLS <val_ref> TYPE any.
    DATA temp255 LIKE LINE OF mt_attri->*.
    DATA lr_attri_dref LIKE REF TO temp255.
  ...
  METHOD attri_search.
    ...
    DATA temp256 LIKE LINE OF mt_attri->*.
  ...
  METHOD attri_create_new.
    ...
    DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp257 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    lo_descr = z2ui5_cl_ui5_util_context=>rtti_get_typedescr_by_data_ref( attri_get_val_ref( name ) ).

    CLEAR temp257.
    temp257-name = name.
    temp257-o_typedescr = lo_descr.
    temp257-type_kind = lo_descr->type_kind.
    temp257-kind = lo_descr->kind.
    result = temp257.
  ...
  METHOD diss_dref.
    ...
    DATA lr_ref TYPE REF TO data.
    DATA temp258 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA ls_attri2 LIKE temp258.
  ...
  METHOD diss_oref.
    ...
    DATA temp259 TYPE string.
    DATA lv_prefix LIKE temp259.
    DATA temp260 LIKE LINE OF lt_attri.
  ...
  METHOD dissolve.
    ...
    DO max_dissolve_depth TIMES.
      ...
      IF mt_attri->* IS NOT INITIAL
          AND NOT temp261 = 0. "#EC CI_SORTSEQ
        EXIT.
      ENDIF.
  ...
  METHOD attri_update_refs_children.
    ...
    DATA lr_attri_child LIKE REF TO temp263.
      DATA lv_name TYPE string.
    LOOP AT mt_attri->* REFERENCE INTO lr_attri_child "#EC CI_SORTSEQ
         WHERE name_parent = ir_attri->name.
  ...
  METHOD dissolve_run.
      ...
      DATA ls_attri LIKE temp264.
      DATA temp265 LIKE REF TO ls_attri.
DATA lt_init TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp266 TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp266.
    DATA temp267 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp267.
    ...
    IF mt_attri->* IS INITIAL.
      ...
      GET REFERENCE OF ls_attri INTO temp265.

lt_init = diss_oref( temp265 ).
...
GET REFERENCE OF <comp> INTO temp270.
