...
CLASS z2ui5_cl_ui5_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_to_attri.
    ...
    DATA lr_attri LIKE REF TO temp293.
  ...
  METHOD main_json_stringify.
        DATA temp294 TYPE REF TO z2ui5_if_ajson.
        DATA li_ajson_result LIKE temp294.
...
DATA lt_mapper_cache TYPE temp1.
    ...
    TRY.
        ...
        temp294 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ui5_util_json_fl=>mapper_upper( ) ).

        li_ajson_result = temp294.
          ...
          IF lr_attri->custom_mapper IS BOUND OR lr_attri->custom_filter IS BOUND.
            IF lr_attri->custom_mapper IS BOUND.
              ...
              ELSE.
                ...
                CLEAR temp296.
                temp296-mapper = lr_attri->custom_mapper.
                temp296-ajson = ajson.
                INSERT temp296 INTO TABLE lt_mapper_cache.
              ENDIF.
            ELSE.
  ...
  METHOD main_attri_db_load.
    DATA temp297 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp297.
  ...
  METHOD main_attri_db_load_resolve.
    ...
    DATA temp298 LIKE LINE OF mt_attri->*.
  ...
  METHOD check_attri_bound.
    ...
    DATA temp299 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp299.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    DATA lr_attri LIKE REF TO temp300.
      ...
      DATA temp301 TYPE REF TO data.
DATA temp65 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp302 LIKE LINE OF lt_dref.
    DATA lr_dref LIKE REF TO temp302.
        DATA temp303 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
...
GET REFERENCE OF <dref> INTO temp301.
...
INSERT temp65 INTO TABLE lt_dref.
    ...
    LOOP AT lt_dref REFERENCE INTO lr_dref.
      ...
      IF <dref> IS BOUND.
        ...
        CLEAR temp303.
        temp303-name = lr_dref->name.
        temp303-ref = <dref>.
        INSERT temp303 INTO TABLE mt_detached.
      ENDIF.
      CLEAR <dref>.
    ENDLOOP.
  ...
  METHOD main_attri_reattach.
    ...
    DATA temp304 LIKE LINE OF mt_detached.
    DATA lr_detached LIKE REF TO temp304.
  ...
  METHOD ref_idx_put.
    ...
    DATA lr_idx TYPE REF TO z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA temp306 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
    ...
    ELSE.
      ...
      CLEAR temp306.
      temp306-name = iv_name.
      temp306-ref = ir_ref.
      INSERT temp306 INTO TABLE mt_ref_idx.
    ENDIF.
  ...
  METHOD attri_search.
    ...
    DATA temp307 LIKE LINE OF mt_ref_idx.
    DATA lr_idx LIKE REF TO temp307.
  ...
  METHOD attri_create_new.
    ...
    DATA lr_ref TYPE REF TO data.
    DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp309 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    ...
    CLEAR temp309.
    temp309-name = name.
    temp309-o_typedescr = lo_descr.
    temp309-type_name = lo_descr->absolute_name.
    temp309-type_kind = lo_descr->type_kind.
    temp309-kind = lo_descr->kind.
    result = temp309.
  ...
  METHOD diss_dref.
    ...
    DATA lr_ref TYPE REF TO data.
    DATA lo_descr TYPE REF TO cl_abap_typedescr.
        DATA temp310 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    ...
    CASE lo_descr->kind.
      ...
      WHEN OTHERS.
        ...
        CLEAR temp310.
        temp310-name = |{ ir_attri->name }->*|.
        temp310-name_parent = ir_attri->name.
        temp310-o_typedescr = lo_descr.
        temp310-type_name = lo_descr->absolute_name.
        temp310-type_kind = lo_descr->type_kind.
        temp310-kind = lo_descr->kind.
        INSERT temp310 INTO TABLE result.
  ...
  METHOD diss_oref.
    ...
    DATA temp312 LIKE LINE OF lt_attri.
    DATA lr_attri LIKE REF TO temp312.
  ...
  METHOD diss_struc.
    ...
    DATA temp313 LIKE LINE OF lt_attri.
    DATA lr_comp LIKE REF TO temp313.
      DATA ls_new TYPE z2ui5_if_ui5_types=>ty_s_attri.
    lr_val = attri_get_val_ref( ir_attri->name ).
  ...
  METHOD dissolve.
    ...
    DO max_dissolve_passes TIMES.
      ...
      IF mt_attri->* IS NOT INITIAL
          AND NOT temp314 = 0. "#EC CI_SORTSEQ
        EXIT.
      ENDIF.
  ...
  METHOD attri_update_entry_refs.
    ...
    DATA temp315 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp315.
          DATA lr_ref TYPE REF TO data.
      DATA temp316 TYPE ty_s_resolved.
      DATA ls_resolved LIKE temp316.
    DATA temp317 LIKE LINE OF lt_resolved.
    DATA lr_res LIKE REF TO temp317.
    LOOP AT mt_attri->* REFERENCE INTO lr_attri   "#EC CI_SORTSEQ
      ...
      CLEAR temp316.
      temp316-name = lr_attri->name.
      temp316-type_kind = lr_attri->type_kind.
      temp316-attri = lr_attri.
      temp316-ref = lr_ref.
  ...
  METHOD entry_refs_pair_table.
    DATA temp318 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp318.
  ...
  METHOD entry_refs_pair_dref.
    DATA temp319 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp319.
  ...
  METHOD refs_below_set.
    ...
    DATA temp320 LIKE LINE OF mt_attri->*.
    DATA lr_child LIKE REF TO temp320.
  ...
  METHOD dissolve_run.
      ...
      DATA ls_attri LIKE temp321.
      DATA temp322 LIKE REF TO ls_attri.
DATA lt_init TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp323 TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp323.
    DATA temp324 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp324.
    ...
    IF mt_attri->* IS INITIAL.
      ...
      GET REFERENCE OF ls_attri INTO temp322.

lt_init = diss_oref( temp322 ).
  ...
  METHOD main_attri_refresh.
    ...
    DATA temp325 LIKE LINE OF mt_attri->*.
    DATA lr_bound LIKE REF TO temp325.
    DATA temp326 LIKE LINE OF lt_attri.
    DATA lr_old LIKE REF TO temp326.
...
GET REFERENCE OF <before> INTO temp327.
...
delta_apply_field( EXPORTING io_delta    = io_delta
  ...
  METHOD delta_skip_nodes.
    ...
    DATA lv_idx_str LIKE LINE OF lt_idx.
      ...
      DATA lt_fld TYPE string_table.
      DATA lv_fld LIKE LINE OF lt_fld.
        DATA temp328 TYPE z2ui5_if_client=>ty_s_model_skip.
    lt_idx = io_delta->members( iv_base ).
    ...
    LOOP AT lt_idx INTO lv_idx_str.
      ...
      LOOP AT lt_fld INTO lv_fld.
        ...
        CLEAR temp328.
        temp328-name = iv_table.
        temp328-row = lv_tabix.
        temp328-field = lv_fld.
        temp328-row_parent = iv_row_parent.
  ...
  METHOD delta_col_kind.
    ...
    FIELD-SYMBOLS <comp> TYPE any.
    DATA temp330 TYPE ty_s_col_kind.
    DATA ls_col_kind LIKE temp330.
    ...
    CLEAR temp330.
    temp330-field = is_cell-field.
    temp330-type_kind = z2ui5_cl_ui5_util_context=>rtti_get_type_kind( <comp> ).
  ...
  METHOD whole_value_trace.
    ...
    DATA temp331 TYPE z2ui5_if_client=>ty_s_model_skip.
    DATA ls_skip LIKE temp331.
    CLEAR temp331.
    temp331-name = iv_name.
