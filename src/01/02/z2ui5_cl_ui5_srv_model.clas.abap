...
CLASS z2ui5_cl_ui5_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_to_attri.
    ...
    DATA lr_attri LIKE REF TO temp279.
  ...
  METHOD main_json_stringify.
        ...
        DATA li_ajson_result LIKE temp280.
...
DATA lt_mapper_cache TYPE temp1.
    ...
    TRY.
        ...
        temp280 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ui5_util_json_fl=>mapper_upper( ) ).

        li_ajson_result = temp280.
          ...
          IF lr_attri->custom_mapper IS BOUND OR lr_attri->custom_filter IS BOUND.
            IF lr_attri->custom_mapper IS BOUND.
              ...
              ELSE.
                ...
                CLEAR temp282.
                temp282-mapper = lr_attri->custom_mapper.
                temp282-ajson = ajson.
                INSERT temp282 INTO TABLE lt_mapper_cache.
              ENDIF.
            ELSE.
  ...
  METHOD check_attri_bound.
    ...
    DATA temp285 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp285.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    DATA lr_attri LIKE REF TO temp286.
      DATA lv_path_dref TYPE string.
      DATA temp287 TYPE REF TO data.
DATA temp65 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp288 LIKE LINE OF lt_dref.
    DATA lr_dref LIKE REF TO temp288.
        DATA temp289 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
...
GET REFERENCE OF <dref> INTO temp287.
...
INSERT temp65 INTO TABLE lt_dref.
    ...
    LOOP AT lt_dref REFERENCE INTO lr_dref.
      ...
      IF <dref> IS BOUND.
        ...
        CLEAR temp289.
        temp289-name = lr_dref->name.
        temp289-ref = <dref>.
        INSERT temp289 INTO TABLE mt_detached.
      ENDIF.
      CLEAR <dref>.
    ENDLOOP.
  ...
  METHOD main_attri_reattach.
    ...
    DATA temp290 LIKE LINE OF mt_detached.
    DATA lr_detached LIKE REF TO temp290.
  ...
  METHOD ref_idx_put.
    ...
    DATA lr_idx TYPE REF TO z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA temp292 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
    ...
    ELSE.
      ...
      CLEAR temp292.
      temp292-name = iv_name.
      temp292-ref = ir_ref.
      INSERT temp292 INTO TABLE mt_ref_idx.
    ENDIF.
  ...
  METHOD attri_search.
    ...
    DATA temp293 LIKE LINE OF mt_ref_idx.
    DATA lr_idx LIKE REF TO temp293.
  ...
  METHOD attri_create_new.
    ...
    temp295-type_name = lo_descr->absolute_name.
  ...
  METHOD diss_dref.
    ...
    CASE lo_descr->kind.
      ...
      WHEN OTHERS.
        ...
        CLEAR temp296.
        temp296-name = |{ ir_attri->name }->*|.
        temp296-name_parent = ir_attri->name.
        temp296-o_typedescr = lo_descr.
        temp296-type_name = lo_descr->absolute_name.
        temp296-type_kind = lo_descr->type_kind.
        temp296-kind = lo_descr->kind.
        INSERT temp296 INTO TABLE result.
  ...
  METHOD diss_struc.
    ...
    DATA temp299 LIKE LINE OF lt_attri.
    DATA lr_comp LIKE REF TO temp299.
      DATA ls_new TYPE z2ui5_if_ui5_types=>ty_s_attri.
    lr_val = attri_get_val_ref( ir_attri->name ).
  ...
  METHOD dissolve.
    ...
    DO max_dissolve_passes TIMES.
      ...
      IF mt_attri->* IS NOT INITIAL
          AND NOT temp300 = 0. "#EC CI_SORTSEQ
        EXIT.
      ENDIF.
  ...
  METHOD attri_update_entry_refs.
    ...
    DATA lr_attri LIKE REF TO temp301.
          DATA lr_ref TYPE REF TO data.
      DATA temp302 TYPE ty_s_resolved.
      DATA ls_resolved LIKE temp302.
    DATA temp303 LIKE LINE OF lt_resolved.
    DATA lr_res LIKE REF TO temp303.
    LOOP AT mt_attri->* REFERENCE INTO lr_attri   "#EC CI_SORTSEQ
      ...
      CLEAR temp302.
      temp302-name = lr_attri->name.
      temp302-type_kind = lr_attri->type_kind.
      temp302-attri = lr_attri.
      temp302-ref = lr_ref.
  ...
  METHOD entry_refs_pair_table.
    DATA temp304 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp304.
  ...
  METHOD entry_refs_pair_dref.
    DATA temp305 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp305.
  ...
  METHOD refs_below_set.
    ...
    DATA lr_child LIKE REF TO temp306.
  ...
  METHOD dissolve_run.
      DATA temp307 TYPE z2ui5_if_ui5_types=>ty_s_attri.
      DATA ls_attri LIKE temp307.
      DATA temp308 LIKE REF TO ls_attri.
DATA lt_init TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp309 TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp309.
    ...
    IF mt_attri->* IS INITIAL.
      ...
      GET REFERENCE OF ls_attri INTO temp308.

lt_init = diss_oref( temp308 ).
  ...
  METHOD main_attri_refresh.
    ...
    DATA lr_bound LIKE REF TO temp311.
    DATA temp312 LIKE LINE OF lt_attri.
    DATA lr_old LIKE REF TO temp312.
...
GET REFERENCE OF <before> INTO temp313.
...
delta_apply_field( EXPORTING io_delta    = io_delta
  ...
  METHOD delta_skip_nodes.
    ...
    DATA lv_idx_str LIKE LINE OF lt_idx.
      ...
      DATA lt_fld TYPE string_table.
      DATA lv_fld LIKE LINE OF lt_fld.
        DATA temp314 TYPE z2ui5_if_client=>ty_s_model_skip.
    lt_idx = io_delta->members( iv_base ).
    ...
    LOOP AT lt_idx INTO lv_idx_str.
      ...
      LOOP AT lt_fld INTO lv_fld.
        ...
        CLEAR temp314.
        temp314-name = iv_table.
        temp314-row = lv_tabix.
        temp314-field = lv_fld.
        temp314-row_parent = iv_row_parent.
  ...
  METHOD delta_col_kind.
    ...
    FIELD-SYMBOLS <comp> TYPE any.
    DATA temp316 TYPE ty_s_col_kind.
    DATA ls_col_kind LIKE temp316.
    ...
    CLEAR temp316.
    temp316-field = is_cell-field.
    temp316-type_kind = z2ui5_cl_ui5_util_context=>rtti_get_type_kind( <comp> ).
  ...
  METHOD whole_value_trace.
    ...
    DATA temp317 TYPE z2ui5_if_client=>ty_s_model_skip.
    DATA ls_skip LIKE temp317.
    CLEAR temp317.
