...
CLASS z2ui5_cl_ui5_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_stringify.
        DATA temp269 TYPE REF TO z2ui5_if_ajson.
        DATA li_ajson_result LIKE temp269.
...
DATA lt_mapper_cache TYPE temp1.
    ...
    TRY.
        ...
        temp269 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = mapper_upper( ) ).

        li_ajson_result = temp269.
          ...
          IF lr_attri->custom_mapper IS BOUND OR lr_attri->custom_filter IS BOUND.
            IF lr_attri->custom_mapper IS BOUND.
              ...
              ELSE.
                ...
                CLEAR temp271.
                temp271-mapper = lr_attri->custom_mapper.
                temp271-ajson = ajson.
                INSERT temp271 INTO TABLE lt_mapper_cache.
              ENDIF.
            ELSE.
  ...
  METHOD main_attri_db_load.
    DATA temp272 LIKE LINE OF mt_attri->*.
  ...
  METHOD main_attri_db_load_resolve.
    ...
    DATA temp273 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp273.
          DATA lr_ref TYPE REF TO data.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    DATA temp275 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp275.
      DATA lv_path_dref TYPE string.
      DATA temp276 TYPE REF TO data.
DATA temp65 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp277 LIKE LINE OF lt_dref.
    DATA lr_dref LIKE REF TO temp277.
        DATA temp278 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
...
GET REFERENCE OF <dref> INTO temp276.
...
INSERT temp65 INTO TABLE lt_dref.
    ...
    LOOP AT lt_dref REFERENCE INTO lr_dref.
      ...
      IF <dref> IS BOUND.
        ...
        CLEAR temp278.
        temp278-name = lr_dref->name.
        temp278-ref = <dref>.
        INSERT temp278 INTO TABLE mt_detached.
      ENDIF.
      CLEAR <dref>.
    ENDLOOP.
  ...
  METHOD main_attri_reattach.
    ...
    DATA temp279 LIKE LINE OF mt_detached.
    DATA lr_detached LIKE REF TO temp279.
  ...
  METHOD ref_idx_put.
    ...
    DATA lr_idx TYPE REF TO z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
      DATA temp281 TYPE z2ui5_cl_ui5_srv_model=>ty_s_ref_idx.
    ...
    ELSE.
      ...
      CLEAR temp281.
      temp281-name = iv_name.
      temp281-ref = ir_ref.
      INSERT temp281 INTO TABLE mt_ref_idx.
    ENDIF.
  ...
  METHOD attri_search.
    ...
    DATA temp282 LIKE LINE OF mt_ref_idx.
    DATA lr_idx LIKE REF TO temp282.
  ...
  METHOD attri_create_new.
    ...
    DATA lr_ref TYPE REF TO data.
    DATA lo_descr TYPE REF TO cl_abap_typedescr.
    DATA temp284 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    ...
    CLEAR temp284.
    temp284-name = name.
    temp284-o_typedescr = lo_descr.
    temp284-type_name = lo_descr->absolute_name.
    temp284-type_kind = lo_descr->type_kind.
    temp284-kind = lo_descr->kind.
    result = temp284.
  ...
  METHOD diss_dref.
    ...
    DATA lr_ref TYPE REF TO data.
    DATA lo_descr TYPE REF TO cl_abap_typedescr.
        DATA temp285 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    ...
    CASE lo_descr->kind.
      ...
      WHEN OTHERS.
        ...
        CLEAR temp285.
        temp285-name = |{ ir_attri->name }->*|.
        temp285-name_parent = ir_attri->name.
        temp285-o_typedescr = lo_descr.
        temp285-type_name = lo_descr->absolute_name.
        temp285-type_kind = lo_descr->type_kind.
        temp285-kind = lo_descr->kind.
        INSERT temp285 INTO TABLE result.
  ...
  METHOD diss_oref.
    ...
    DATA lv_prefix LIKE temp286.
    DATA temp287 LIKE LINE OF lt_attri.
    DATA lr_attri LIKE REF TO temp287.
  ...
  METHOD diss_struc.
    ...
    DATA temp288 LIKE LINE OF lt_attri.
    DATA lr_comp LIKE REF TO temp288.
      DATA ls_new TYPE z2ui5_if_ui5_types=>ty_s_attri.
    lr_val = attri_get_val_ref( ir_attri->name ).
  ...
  METHOD dissolve.
    ...
    DO max_dissolve_passes TIMES.
      ...
      IF mt_attri->* IS NOT INITIAL
          AND NOT temp289 = 0. "#EC CI_SORTSEQ
        EXIT.
      ENDIF.
  ...
  METHOD attri_update_entry_refs.
    ...
    DATA temp290 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp290.
          DATA lr_ref TYPE REF TO data.
      DATA temp291 TYPE ty_s_resolved.
      DATA ls_resolved LIKE temp291.
    DATA temp292 LIKE LINE OF lt_resolved.
    DATA lr_res LIKE REF TO temp292.
    LOOP AT mt_attri->* REFERENCE INTO lr_attri   "#EC CI_SORTSEQ
      ...
      CLEAR temp291.
      temp291-name = lr_attri->name.
      temp291-type_kind = lr_attri->type_kind.
      temp291-attri = lr_attri.
      temp291-ref = lr_ref.
  ...
  METHOD entry_refs_pair_table.
    DATA temp293 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp293.
  ...
  METHOD entry_refs_pair_dref.
    DATA temp294 LIKE LINE OF it_resolved.
    DATA lr_other LIKE REF TO temp294.
  ...
  METHOD refs_below_set.
    ...
    DATA lr_child LIKE REF TO temp295.
  ...
  METHOD dissolve_run.
      ...
      DATA ls_attri LIKE temp296.
      DATA temp297 LIKE REF TO ls_attri.
DATA lt_init TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp298 TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp298.
    ...
    IF mt_attri->* IS INITIAL.
      ...
      GET REFERENCE OF ls_attri INTO temp297.

lt_init = diss_oref( temp297 ).
  ...
  METHOD main_attri_refresh.
    ...
    DATA lr_bound LIKE REF TO temp300.
    DATA temp301 LIKE LINE OF lt_attri.
    DATA lr_old LIKE REF TO temp301.
...
GET REFERENCE OF <before> INTO temp302.
...
delta_apply_field( EXPORTING io_delta    = io_delta
  ...
  METHOD delta_skip_nodes.
    ...
    DATA lv_idx_str LIKE LINE OF lt_idx.
      ...
      DATA lt_fld TYPE string_table.
      DATA lv_fld LIKE LINE OF lt_fld.
        DATA temp303 TYPE z2ui5_if_client=>ty_s_model_skip.
    lt_idx = io_delta->members( iv_base ).
    ...
    LOOP AT lt_idx INTO lv_idx_str.
      ...
      LOOP AT lt_fld INTO lv_fld.
        ...
        CLEAR temp303.
        temp303-name = iv_table.
        temp303-row = lv_tabix.
        temp303-field = lv_fld.
        temp303-row_parent = iv_row_parent.
  ...
  METHOD delta_col_kind.
    ...
    FIELD-SYMBOLS <comp> TYPE any.
    DATA temp305 TYPE ty_s_col_kind.
    DATA ls_col_kind LIKE temp305.
    ...
    CLEAR temp305.
    temp305-field = is_cell-field.
    temp305-type_kind = z2ui5_cl_ui5_util_context=>rtti_get_type_kind( <comp> ).
  ...
  METHOD whole_value_trace.
    ...
    DATA temp306 TYPE z2ui5_if_client=>ty_s_model_skip.
    DATA ls_skip LIKE temp306.
    CLEAR temp306.
