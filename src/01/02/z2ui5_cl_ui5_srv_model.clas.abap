...
CLASS z2ui5_cl_ui5_srv_model IMPLEMENTATION.
    ...
    TRY.
        ...
        LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri) "#EC CI_SORTSEQ
             WHERE bind = abap_true
                   AND type_kind <> z2ui5_cl_ui5_context=>cv_typedescr_typekind_dref
                   AND type_kind <> z2ui5_cl_ui5_context=>cv_typedescr_typekind_oref.
  ...
  METHOD main_attri_db_load.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      CASE lr_attri->type_kind.
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_table.
          main_attri_db_load_table( lr_attri ).
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_dref.
  ...
  METHOD main_attri_db_load_resolve.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      TRY.
          DATA(lr_ref) = attri_get_val_ref( lr_attri->name ).
          lr_attri->o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( lr_ref ).
          IF lr_attri->srtti_data IS NOT INITIAL.
            ASSIGN lr_ref->* TO FIELD-SYMBOL(<val>).
            <val> = z2ui5_cl_ui5_context=>xml_srtti_parse( lr_attri->srtti_data ).
  ...
  METHOD main_attri_db_load_table.
    ...
    ir_attri->o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( lr_ref_source ).
    ...
    lr_attri_parent->o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( lr_ref_parent ).
  ...
  METHOD main_attri_db_load_dref.
    ...
    ir_attri->o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( <parent_ref> ).
    ...
    LOOP AT ir_child_idx->* REFERENCE INTO DATA(lr_child_idx)
      ...
      lr_child->o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( lr_child_ref ).
    ENDLOOP.
  ...
  METHOD main_attri_db_save_srtti.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      IF sy-subrc <> 0.
        CONTINUE.
      ENDIF.
      DATA(lo_descr) = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data( <val_deref> ).
      ...
      CASE lo_descr->type_kind.
        ...
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_table.
          ...
          LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri_child) "#EC CI_SORTSEQ
               WHERE name_ref IS INITIAL
                     AND type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_table
            ...
            IF sy-subrc <> 0.
              CONTINUE.
            ENDIF.
            lr_attri->srtti_data = z2ui5_cl_ui5_context=>xml_srtti_stringify( <val_ref> ).
            CLEAR <val_ref>.
            CLEAR <val_deref>.
            CLEAR <ref>.
            EXIT.
        ...
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_struct1 OR z2ui5_cl_ui5_context=>cv_typedescr_typekind_struct2.
          lr_attri->srtti_data = z2ui5_cl_ui5_context=>xml_srtti_stringify( <val_deref> ).
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri_dref)  "#EC CI_SORTSEQ
         WHERE type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_dref.
  ...
  METHOD attri_search.
    ...
    DATA(lo_datadescr) = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( val ).

    IF lo_datadescr->type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_dref
        OR lo_datadescr->type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_oref.
      RAISE EXCEPTION TYPE z2ui5_cx_ui5_error
        EXPORTING
  ...
  METHOD attri_create_new.
    ...
    DATA(lo_descr) = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( attri_get_val_ref( name ) ).
  ...
  METHOD diss_dref.
    ...
    IF z2ui5_cl_ui5_context=>check_unassign_initial( lr_ref_tmp ).
      RETURN.
    ENDIF.

    DATA(lr_ref) = z2ui5_cl_ui5_context=>unassign_data( lr_ref_tmp ).
    IF lr_ref IS INITIAL.
      RETURN.
    ENDIF.

    DATA(ls_attri2) = VALUE z2ui5_if_ui5_types=>ty_s_attri( ).
    ls_attri2-o_typedescr = z2ui5_cl_ui5_context=>rtti_get_typedescr_by_data_ref( lr_ref ).

    CASE ls_attri2-o_typedescr->kind.

      WHEN z2ui5_cl_ui5_context=>cv_typedescr_kind_struct.
  ...
  METHOD diss_oref.
    ...
    IF z2ui5_cl_ui5_context=>check_unassign_initial( lr_val ).
      RETURN.
    ENDIF.

    DATA(lr_ref) = z2ui5_cl_ui5_context=>unassign_object( lr_val ).
    DATA(lt_attri) = z2ui5_cl_ui5_context=>rtti_get_t_attri_by_oref( lr_ref ).

    DATA(lv_prefix) = COND string( WHEN ir_attri->name IS NOT INITIAL THEN |{ ir_attri->name }->| ).

    LOOP AT lt_attri REFERENCE INTO DATA(lr_attri)
         WHERE visibility   = z2ui5_cl_ui5_context=>cv_objectdescr_public
  ...
  METHOD diss_struc.
    ...
    IF ir_attri->o_typedescr->kind = z2ui5_cl_ui5_context=>cv_typedescr_kind_ref.
      DATA(lv_name) = |{ ir_attri->name }->|.
      DATA(lr_ref) = z2ui5_cl_ui5_context=>unassign_data( lr_val ).
    ELSE.
    ...
    IF lr_ref IS BOUND.
      DATA(lt_attri) = z2ui5_cl_ui5_context=>rtti_get_t_attri_by_any( lr_ref ).
        ...
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_dref.
          ...
          LOOP AT mt_attri->* REFERENCE INTO lr_attri_ref "#EC CI_SORTSEQ
               WHERE check_dissolved = abap_true
                     AND name <> lr_attri->name
                     AND name_ref IS INITIAL
                     AND (    type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_struct1
                           OR type_kind = z2ui5_cl_ui5_context=>cv_typedescr_typekind_struct2 ).
  ...
  METHOD dissolve_run.
    ...
    LOOP AT mt_attri->* REFERENCE INTO DATA(lr_attri)   "#EC CI_SORTSEQ
      ...
      CASE lr_attri->o_typedescr->kind.
        ...
        WHEN z2ui5_cl_ui5_context=>cv_typedescr_kind_ref.

          CASE lr_attri->o_typedescr->type_kind.

            WHEN z2ui5_cl_ui5_context=>cv_typedescr_typekind_oref.
