...
CLASS z2ui5_cl_core_srv_json IMPLEMENTATION.
  ...
  METHOD model_back_to_front.
        ...
        DATA temp8 LIKE LINE OF t_attri->*.
    ...
    TRY.
        ...
        temp7 ?= z2ui5_cl_ajson=>create_empty( ).
        ...
        LOOP AT t_attri->* REFERENCE INTO lr_attri WHERE bind_type <> ``.
          ...
          IF lr_attri->custom_mapper IS BOUND.
            ...
            temp9 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = lr_attri->custom_mapper ).
  ...
  METHOD request_json_to_abap.
    ...
    TRY.
        ...
        temp12 ?= z2ui5_cl_ajson=>parse( val ).
  ...
  METHOD response_abap_to_json.
        ...
        DATA ajson_result LIKE temp13.
        DATA temp14 TYPE REF TO z2ui5_cl_core_srv_json.
        DATA lv_frontend TYPE string.
        DATA x TYPE REF TO cx_root.
    TRY.

        
        temp13 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ajson_mapping=>create_upper_case( ) ).
        ...
        CREATE OBJECT temp14 TYPE z2ui5_cl_core_srv_json.
        ajson_result = ajson_result->filter( temp14 ).
