...
CLASS z2ui5_cl_ui5_frontend IMPLEMENTATION.
  ...
  METHOD nav_serialize.
    ...
    TRY.
        ...
        temp22-name = `setHashReplace`.
        temp22-val = ls_nav-hash_replace.
        INSERT temp22 INTO TABLE temp21.
        temp22-name = `setNavRouting`.
        temp22-val = ls_nav-set_nav_routing.
        INSERT temp22 INTO TABLE temp21.
        temp22-name = `setHashEvent`.
        temp22-val = ls_nav-set_hash_listener.
        INSERT temp22 INTO TABLE temp21.
        ...
        CLEAR temp23.
        INSERT z2ui5_if_ui5_types=>cs_global_target-router INTO TABLE temp23.
  ...
  METHOD box_resolve.
    ...
    IF z2ui5_cl_ui5_util_context=>rtti_check_clike( text ) = abap_false.
      ...
      temp4 = boolc( result-skip = abap_false ).
      lv_is_msg = temp4.
    ENDIF.
