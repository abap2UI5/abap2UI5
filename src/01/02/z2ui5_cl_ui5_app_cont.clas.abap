...
CLASS z2ui5_cl_ui5_app_cont IMPLEMENTATION.
  ...
  METHOD db_load.
    ...
    DATA lv_id LIKE temp32.
    DATA lr_buf TYPE REF TO z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    DATA temp33 TYPE z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    temp32 = id.
    ...
    temp33-id = lv_id.
    temp33-app = result.
    INSERT temp33 INTO TABLE mt_buffer.
  ...
  METHOD db_load_by_app.
    ...
    " here, as before
    DATA lr_buf TYPE REF TO z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    DATA temp34 TYPE z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    ...
    CLEAR temp34.
    temp34-id = app->id_draft.
    temp34-app = result.
    INSERT temp34 INTO TABLE mt_buffer.

  ENDMETHOD.

  METHOD app_refresh_draft_id.
    DATA temp35 TYPE REF TO z2ui5_if_app.
