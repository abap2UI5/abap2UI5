...
CLASS z2ui5_cl_ui5_app_cont IMPLEMENTATION.
  ...
  METHOD db_load_by_app.
    ...
    " here, as before
    DATA lr_buf TYPE REF TO z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    DATA temp32 TYPE z2ui5_cl_ui5_app_cont=>ty_s_buffer.
    ...
    CLEAR temp32.
    temp32-id = app->id_draft.
    temp32-app = result.
    INSERT temp32 INTO TABLE mt_buffer.
  ...
  METHOD app_refresh_draft_id.
    ...
    temp33 ?= mo_app.
    temp33->id_draft = ms_draft-id.

  ENDMETHOD.

  METHOD db_save.
    DATA temp34 TYPE REF TO z2ui5_cl_ui5_srv_draft.
    ...
    CREATE OBJECT temp34 TYPE z2ui5_cl_ui5_srv_draft.
    temp34->create( draft     = ms_draft
  ...
  METHOD draft_parse.
    ...
    DATA temp4 TYPE REF TO z2ui5_cl_ui5_srv_draft.
    CREATE OBJECT temp4 TYPE z2ui5_cl_ui5_srv_draft.
    ls_db = temp4->read_draft( iv_id ).
