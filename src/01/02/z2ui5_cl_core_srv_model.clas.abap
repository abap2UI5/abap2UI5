...
CLASS z2ui5_cl_core_srv_model IMPLEMENTATION.
  ...
  METHOD main_json_stringify.
        ...
        DATA ajson_result LIKE temp76.
        DATA temp77 LIKE LINE OF mt_attri->*.
        DATA lr_attri LIKE REF TO temp77.
            DATA temp78 TYPE REF TO z2ui5_if_ajson.
            DATA ajson LIKE temp78.
            DATA temp79 TYPE REF TO z2ui5_if_ajson.
              DATA lr_ref TYPE REF TO data.
    ...
    TRY.
        ...
        temp76 ?= z2ui5_cl_ajson=>create_empty( ).
        ...
        LOOP AT mt_attri->* REFERENCE INTO lr_attri
          ...
          IF lr_attri->custom_mapper IS BOUND.
            ...
            temp78 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = lr_attri->custom_mapper ).
            
            ajson = temp78.
          ELSE.
            
            temp79 ?= z2ui5_cl_ajson=>create_empty( ii_custom_mapping = z2ui5_cl_ajson_mapping=>create_upper_case( ) ).
            ajson = temp79.
          ENDIF.
  ...
  METHOD main_attri_db_load.
    ...
    DATA lr_attri LIKE REF TO temp81.
          ...
          DATA lr_child LIKE REF TO temp82.
...
GET REFERENCE OF <val4> INTO lr_ref_parent.
        ...
        WHEN cl_abap_datadescr=>typekind_dref.
          ...
          LOOP AT mt_attri->* REFERENCE INTO lr_child WHERE
  ...
  METHOD main_attri_db_save_srtti.
    ...
    DATA lr_attri LIKE REF TO temp83.
      ...
      DATA lo_descr TYPE REF TO cl_abap_typedescr.
          ...
          DATA lr_attri_child LIKE REF TO temp84.
            DATA lv_name6 TYPE string.
            FIELD-SYMBOLS <val_ref> TYPE any.
    DATA temp85 LIKE LINE OF mt_attri->*.
    DATA lr_attri2 LIKE REF TO temp85.
...
*            ENDLOOP.
    ...
    LOOP AT mt_attri->* REFERENCE INTO lr_attri2
*        WHERE name_ref IS INITIAL
  ...
  METHOD attri_search.
    ...
    DATA temp86 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp86.
          DATA lr_ref TYPE REF TO data.
  ...
  METHOD diss_oref.
    ...
    DATA lr_attri LIKE REF TO temp89.
    ...
    LOOP AT lt_attri REFERENCE INTO lr_attri
      ...
      TRY.
          ...
          IF ir_attri->name IS NOT INITIAL.
            temp90 = |{ ir_attri->name }->|.
          ELSE.
            CLEAR temp90.
          ENDIF.
          
          lv_name = temp90 && lr_attri->name.
  ...
  METHOD dissolve.
    ...
    temp91 = sy-subrc.
    WHILE temp91 = 0 OR mt_attri->* IS INITIAL.
  ...
  METHOD attri_update_entry_refs.
    ...
    DATA lr_attri LIKE REF TO temp92.
      DATA lr_ref TYPE REF TO data.
          DATA temp93 LIKE LINE OF mt_attri->*.
          DATA lr_attri_ref LIKE REF TO temp93.
            DATA lr_attri_ref_ref TYPE REF TO data.
          FIELD-SYMBOLS <ref> TYPE data.
            DATA temp94 LIKE LINE OF mt_attri->*.
            DATA lr_attri_child LIKE REF TO temp94.
              DATA lv_name TYPE string.
    LOOP AT mt_attri->* REFERENCE INTO lr_attri
  ...
  METHOD dissolve_run.
      DATA temp95 TYPE z2ui5_if_core_types=>ty_s_attri.
      DATA ls_attri LIKE temp95.
      DATA temp96 LIKE REF TO ls_attri.
DATA lt_init TYPE z2ui5_if_core_types=>ty_t_attri.
    DATA temp97 TYPE z2ui5_if_core_types=>ty_t_attri.
    DATA lt_attri_new LIKE temp97.
    DATA temp98 LIKE LINE OF mt_attri->*.
    DATA lr_attri LIKE REF TO temp98.
    ...
    IF mt_attri->* IS INITIAL.
      ...
      GET REFERENCE OF ls_attri INTO temp96.

lt_init = diss_oref( temp96 ).
    ...
    LOOP AT mt_attri->* REFERENCE INTO lr_attri.
      ...
      IF temp100 = 0.
        ...
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
        lr_attri->bind_type   = temp101-bind_type.
        ...
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
        lr_attri->name_client = temp103-name_client.
        
        
        temp106 = sy-tabix.
        READ TABLE lt_attri WITH KEY name = lv_name INTO temp105.
        sy-tabix = temp106.
        IF sy-subrc <> 0.
          ASSERT 1 = 0.
        ENDIF.
        lr_attri->view        = temp105-view.
      ENDIF.
    ENDLOOP.
