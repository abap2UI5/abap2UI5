...
CLASS z2ui5_cl_ui5_srv_event IMPLEMENTATION.
  ...
  METHOD map_client_event.
    ...
    DATA lv_slot LIKE temp82.
      ...
      DATA lv_bind_path LIKE temp88.
      DATA temp90 TYPE string_table.
      DATA temp10 LIKE LINE OF temp90.
    ...
    IF lv_slot IS NOT INITIAL.
      ...
      IF sy-subrc = 0.
        temp4 = temp5.
      ENDIF.
      INSERT temp4 INTO TABLE temp83.
      INSERT lv_slot INTO TABLE temp83.
      INSERT `to` INTO TABLE temp83.
      ...
      IF sy-subrc = 0.
        temp6 = temp7.
      ENDIF.
      INSERT temp6 INTO TABLE temp83.
      lt_arg = temp83.
    ...
    ELSEIF lv_val = z2ui5_if_client=>cs_event-popup_close
      ...
      CLEAR temp85.
      INSERT z2ui5_if_ui5_types=>cs_slot_action-target INTO TABLE temp85.
      INSERT z2ui5_if_ui5_types=>cs_slot_action-destroy INTO TABLE temp85.
      ...
      ENDIF.
      INSERT temp8 INTO TABLE temp85.
      lt_arg = temp85.
    ...
    ELSEIF lv_val = z2ui5_if_client=>cs_event-bind_element.
      ...
      READ TABLE t_arg INTO temp89 INDEX 2.
      IF sy-subrc = 0.
        temp88 = temp89.
      ENDIF.
      ...
      temp10 = view.
      INSERT temp10 INTO TABLE temp90.
      ...
      IF sy-subrc = 0.
        temp11 = temp12.
      ENDIF.
      INSERT temp11 INTO TABLE temp90.
      INSERT lv_bind_path INTO TABLE temp90.
      lt_arg = temp90.
    ENDIF.
  ...
  METHOD get_event_client_ajson.
    ...
    DATA lv_index TYPE i.
      FIELD-SYMBOLS <temp92> LIKE LINE OF ls_event-t_arg.
      DATA temp93 LIKE sy-tabix.
        DATA temp94 TYPE REF TO z2ui5_if_ajson.
        DATA li_json LIKE temp94.
    ...
    WHILE lv_index > 0.
      ...
      temp93 = sy-tabix.
      READ TABLE ls_event-t_arg INDEX lv_index ASSIGNING <temp92>.
      sy-tabix = temp93.
      IF sy-subrc <> 0.
        ASSERT 1 = 0.
      ENDIF.
      IF <temp92> IS NOT INITIAL.
        EXIT.
      ENDIF.
    ...
    TRY.
        ...
        temp94 ?= z2ui5_cl_ajson=>create_empty( ).
