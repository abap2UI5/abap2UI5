...
CLASS ltcl_test_client IMPLEMENTATION.
  ...
  METHOD test_follow_up_action_ctrl.
    ...
    DATA temp19 LIKE LINE OF mo_action->ms_next-s_set-s_follow_up_action-custom_js.
    ...
    temp20 = sy-tabix.
    READ TABLE mo_action->ms_next-s_set-s_follow_up_action-custom_js INDEX 1 INTO temp19.
    sy-tabix = temp20.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp22 = sy-tabix.
    READ TABLE mo_action->ms_next-s_set-s_follow_up_action-custom_js INDEX 2 INTO temp21.
    sy-tabix = temp22.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
