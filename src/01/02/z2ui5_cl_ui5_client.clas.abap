...
CLASS z2ui5_cl_ui5_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~follow_up_action.
    ...
    DATA lv_arg LIKE temp131.
        DATA temp133 TYPE z2ui5_if_ui5_types=>ty_s_nav-set_hash_listener.
        DATA temp1 TYPE xsdboolean.
    CLEAR temp131.

    READ TABLE t_arg INTO temp132 INDEX 1.
    IF sy-subrc = 0.
      temp131 = temp132.
    ENDIF.
    ...
    CASE val.
      ...
      WHEN z2ui5_if_client=>cs_event-hash_attach_changed.
        ...
        ELSE.
          temp133 = lv_arg.
        ENDIF.
        mo_action->ms_next-s_nav-set_hash_listener = temp133.
        RETURN.
  ...
  METHOD z2ui5_if_client~get.
    ...
    DATA temp5 TYPE xsdboolean.
        ...
        DATA temp134 LIKE LINE OF lo_params->mt_json_tree.
        DATA lr_comp LIKE REF TO temp134.
          DATA temp135 TYPE z2ui5_if_client=>ty_s_name_value.
    ...
    TRY.
        ...
        LOOP AT lo_params->mt_json_tree                 "#EC CI_SORTSEQ
          ...
          CLEAR temp135.
          temp135-n = shift_left( val = shift_right( val = lr_comp->path sub = `/` ) sub = `/` ).
          temp135-v = lr_comp->value.
          INSERT temp135 INTO TABLE mt_comp_params.
        ENDLOOP.
  ...
  METHOD z2ui5_if_client~get_event_arg.
    ...
    DATA temp137 TYPE string.
    CLEAR temp136.

    READ TABLE mo_action->ms_actual-t_event_arg INTO temp137 INDEX v.
    IF sy-subrc = 0.
      temp136 = temp137.
    ENDIF.
    result = temp136.
  ...
  METHOD z2ui5_if_client~get_app.
      ...
      DATA temp138 TYPE REF TO z2ui5_if_app.

    IF id IS NOT INITIAL.

      lo_app = z2ui5_cl_ui5_app_cont=>db_load( id ).

      temp138 ?= lo_app->mo_app.
      result = temp138.
    ELSE.
      result = get_if_app( ).
    ENDIF.
  ...
  METHOD z2ui5_if_client~_bind.
    ...
    DATA temp139 TYPE z2ui5_if_ui5_types=>ty_s_bind_config.
    ...
    CLEAR temp139.
    temp139-path_only = path.
    temp139-custom_filter = li_filter.
    temp139-custom_mapper = custom_mapper.
    temp139-tab = z2ui5_cl_ui5_util_context=>conv_get_as_data_ref( tab ).
    temp139-tab_index = tab_index.
    temp139-switch_default_model = switch_default_model.
    temp139-check_json = json.
  ...
  METHOD z2ui5_if_client~_event.
    ...
    DATA lt_arg LIKE t_arg.
      DATA temp140 LIKE LINE OF lt_arg.
    lt_arg = t_arg.
    IF arg IS SUPPLIED.

      temp140 = arg.
      APPEND temp140 TO lt_arg.
    ENDIF.
  ...
  METHOD z2ui5_if_client~app_state_get_href.
    ...
    IF lv_shell IS INITIAL.
      temp141 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#/{ lv_state }|.
    ELSE.
      temp141 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#{ lv_shell }&/{ lv_state }|.
    ENDIF.
    result = temp141.
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    DATA temp142 TYPE z2ui5_if_ui5_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp142 = 0.
    ENDIF.
    mo_action->ms_next-s_stateful-active = temp142.
  ...
  METHOD get_if_app.
    ...
    DATA temp143 TYPE REF TO z2ui5_if_app.
    temp143 ?= mo_action->mo_app->mo_app.
    result = temp143.
