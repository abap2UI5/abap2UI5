...
CLASS z2ui5_cl_ui5_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~follow_up_action.
    ...
    DATA lv_arg LIKE temp119.
        DATA temp121 TYPE z2ui5_if_ui5_types=>ty_s_nav-set_hash_listener.
        DATA temp1 TYPE xsdboolean.
    CLEAR temp119.

    READ TABLE t_arg INTO temp120 INDEX 1.
    IF sy-subrc = 0.
      temp119 = temp120.
    ENDIF.
    ...
    CASE val.
      ...
      WHEN z2ui5_if_client=>cs_event-hash_attach_changed.
        ...
        ELSE.
          temp121 = lv_arg.
        ENDIF.
        mo_action->ms_next-s_nav-set_hash_listener = temp121.
        RETURN.
  ...
  METHOD z2ui5_if_client~get.
    ...
    DATA temp5 TYPE xsdboolean.
        ...
        DATA temp122 LIKE LINE OF lo_params->mt_json_tree.
        DATA lr_comp LIKE REF TO temp122.
          DATA temp123 TYPE z2ui5_if_client=>ty_s_name_value.
    ...
    TRY.
        ...
        LOOP AT lo_params->mt_json_tree                 "#EC CI_SORTSEQ
          ...
          CLEAR temp123.
          temp123-n = shift_left( val = shift_right( val = lr_comp->path sub = `/` ) sub = `/` ).
          temp123-v = lr_comp->value.
          INSERT temp123 INTO TABLE mt_comp_params.
        ENDLOOP.
  ...
  METHOD z2ui5_if_client~get_event_arg.
    ...
    READ TABLE mo_action->ms_actual-t_event_arg INTO temp125 INDEX v.
    IF sy-subrc = 0.
      temp124 = temp125.
    ENDIF.
    result = temp124.
  ...
  METHOD z2ui5_if_client~get_app.
      ...
      DATA temp126 TYPE REF TO z2ui5_if_app.

    IF id IS NOT INITIAL.

      lo_app = z2ui5_cl_ui5_app_cont=>db_load( id ).

      temp126 ?= lo_app->mo_app.
      result = temp126.
    ELSE.
      result = get_if_app( ).
    ENDIF.
  ...
  METHOD z2ui5_if_client~_bind.
    ...
    DATA temp127 TYPE z2ui5_if_ui5_types=>ty_s_bind_config.
    ...
    CLEAR temp127.
    temp127-path_only = path.
    temp127-custom_filter = li_filter.
    temp127-custom_mapper = custom_mapper.
    temp127-tab = z2ui5_cl_ui5_util_context=>conv_get_as_data_ref( tab ).
    temp127-tab_index = tab_index.
    temp127-switch_default_model = switch_default_model.
    temp127-check_json = json.
  ...
  METHOD z2ui5_if_client~_event.
    ...
    DATA lt_arg LIKE t_arg.
      DATA temp128 LIKE LINE OF lt_arg.
    lt_arg = t_arg.
    IF arg IS SUPPLIED.

      temp128 = arg.
      APPEND temp128 TO lt_arg.
    ENDIF.
  ...
  METHOD z2ui5_if_client~app_state_get_href.
    ...
    IF lv_shell IS INITIAL.
      temp129 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#/{ lv_state }|.
    ELSE.
      temp129 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#{ lv_shell }&/{ lv_state }|.
    ENDIF.
    result = temp129.
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    DATA temp130 TYPE z2ui5_if_ui5_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp130 = 0.
    ENDIF.
    mo_action->ms_next-s_stateful-active = temp130.
  ...
  METHOD get_if_app.
    ...
    DATA temp131 TYPE REF TO z2ui5_if_app.
    temp131 ?= mo_action->mo_app->mo_app.
    result = temp131.
