...
CLASS z2ui5_cl_ui5_client IMPLEMENTATION.
  ...
  METHOD z2ui5_if_client~follow_up_action.
    ...
    DATA lv_arg LIKE temp133.
        DATA temp135 TYPE z2ui5_if_ui5_types=>ty_s_nav-set_hash_listener.
        DATA temp1 TYPE xsdboolean.
    CLEAR temp133.

    READ TABLE t_arg INTO temp134 INDEX 1.
    IF sy-subrc = 0.
      temp133 = temp134.
    ENDIF.
    ...
    CASE val.
      ...
      WHEN z2ui5_if_client=>cs_event-hash_attach_changed.
        ...
        ELSE.
          temp135 = lv_arg.
        ENDIF.
        mo_action->ms_next-s_nav-set_hash_listener = temp135.
        RETURN.
  ...
  METHOD z2ui5_if_client~get.
    ...
    DATA temp5 TYPE xsdboolean.
        ...
        DATA temp136 LIKE LINE OF lo_params->mt_json_tree.
        DATA lr_comp LIKE REF TO temp136.
          DATA temp137 TYPE z2ui5_if_client=>ty_s_name_value.
    ...
    TRY.
        ...
        LOOP AT lo_params->mt_json_tree                 "#EC CI_SORTSEQ
          ...
          CLEAR temp137.
          temp137-n = shift_left( val = shift_right( val = lr_comp->path sub = `/` ) sub = `/` ).
          temp137-v = lr_comp->value.
          INSERT temp137 INTO TABLE mt_comp_params.
        ENDLOOP.
  ...
  METHOD z2ui5_if_client~get_event_arg.
    ...
    READ TABLE mo_action->ms_actual-t_event_arg INTO temp139 INDEX v.
    IF sy-subrc = 0.
      temp138 = temp139.
    ENDIF.
    result = temp138.
  ...
  METHOD z2ui5_if_client~get_app.
      ...
      DATA temp140 TYPE REF TO z2ui5_if_app.

    IF id IS NOT INITIAL.

      lo_app = z2ui5_cl_ui5_app_cont=>db_load( id ).

      temp140 ?= lo_app->mo_app.
      result = temp140.
    ELSE.
      result = get_if_app( ).
    ENDIF.
  ...
  METHOD z2ui5_if_client~_bind.
    ...
    DATA temp141 TYPE z2ui5_if_ui5_types=>ty_s_bind_config.
    ...
    CLEAR temp141.
    temp141-path_only = path.
    temp141-custom_filter = li_filter.
    temp141-custom_mapper = custom_mapper.
    temp141-tab = z2ui5_cl_ui5_util_context=>conv_get_as_data_ref( tab ).
    temp141-tab_index = tab_index.
    temp141-switch_default_model = switch_default_model.
    temp141-check_json = json.
  ...
  METHOD z2ui5_if_client~_event.
    ...
    DATA lt_arg LIKE t_arg.
      DATA temp142 LIKE LINE OF lt_arg.
    lt_arg = t_arg.
    IF arg IS SUPPLIED.

      temp142 = arg.
      APPEND temp142 TO lt_arg.
    ENDIF.
  ...
  METHOD z2ui5_if_client~app_state_get_href.
    ...
    IF lv_shell IS INITIAL.
      temp143 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#/{ lv_state }|.
    ELSE.
      temp143 = |{ ls_front-origin }{ ls_front-pathname }{ ls_front-search }#{ lv_shell }&/{ lv_state }|.
    ENDIF.
    result = temp143.
  ...
  METHOD z2ui5_if_client~set_session_stateful.
    DATA temp144 TYPE z2ui5_if_ui5_types=>ty_s_http_res-s_stateful-active.
    ...
    ELSE.
      temp144 = 0.
    ENDIF.
    mo_action->ms_next-s_stateful-active = temp144.
  ...
  METHOD get_if_app.
    ...
    DATA temp145 TYPE REF TO z2ui5_if_app.
    temp145 ?= mo_action->mo_app->mo_app.
    result = temp145.
