...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp167 LIKE LINE OF lo_app->mt_tab.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp164 app = lo_app.
    ...
    temp166 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 1 INTO temp165.
    sy-tabix = temp166.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp168 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 1 INTO temp167.
    sy-tabix = temp168.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp170 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 2 INTO temp169.
    sy-tabix = temp170.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp176 LIKE LINE OF lo_app->mt_tab.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp173 app = lo_app.
    ...
    temp175 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 1 INTO temp174.
    sy-tabix = temp175.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp177 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 2 INTO temp176.
    sy-tabix = temp177.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp179 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 2 INTO temp178.
    sy-tabix = temp179.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    DATA lo_delta TYPE REF TO z2ui5_if_ajson.
    DATA temp183 LIKE LINE OF lo_app->mt_tab.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp182 app = lo_app.
    ...
    temp184 = sy-tabix.
    READ TABLE lo_app->mt_tab INDEX 1 INTO temp183.
    sy-tabix = temp184.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp189 LIKE LINE OF lo_app->mt_tree.
    DATA temp190 LIKE sy-tabix.
    DATA temp3 LIKE LINE OF temp189-nodes.
    DATA temp4 LIKE sy-tabix.
    DATA temp191 LIKE LINE OF lo_app->mt_tree.
    DATA temp192 LIKE sy-tabix.
    DATA temp5 LIKE LINE OF temp191-nodes.
    DATA temp6 LIKE sy-tabix.
    DATA temp193 LIKE LINE OF lo_app->mt_tree.
    DATA temp194 LIKE sy-tabix.
    DATA temp7 LIKE LINE OF temp193-nodes.
    DATA temp8 LIKE sy-tabix.
    DATA temp195 LIKE LINE OF lo_app->mt_tree.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp187 app = lo_app.
    ...
    temp190 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp189.
    sy-tabix = temp190.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp4 = sy-tabix.
    READ TABLE temp189-nodes INDEX 2 INTO temp3.
    sy-tabix = temp4.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp192 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp191.
    sy-tabix = temp192.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp6 = sy-tabix.
    READ TABLE temp191-nodes INDEX 1 INTO temp5.
    sy-tabix = temp6.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp194 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp193.
    sy-tabix = temp194.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp8 = sy-tabix.
    READ TABLE temp193-nodes INDEX 1 INTO temp7.
    sy-tabix = temp8.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp196 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp195.
    sy-tabix = temp196.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp199 LIKE LINE OF lo_app->mt_tree.
    DATA temp200 LIKE sy-tabix.
    DATA temp201 LIKE LINE OF lo_app->mt_tree.
    DATA temp202 LIKE sy-tabix.
    DATA temp9 LIKE LINE OF temp201-nodes.
    DATA temp10 LIKE sy-tabix.
    DATA temp203 LIKE LINE OF lo_app->mt_tree.
    DATA temp204 LIKE sy-tabix.
    DATA temp11 LIKE LINE OF temp203-nodes.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp197 app = lo_app.
    ...
    temp200 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp199.
    sy-tabix = temp200.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp202 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp201.
    sy-tabix = temp202.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp10 = sy-tabix.
    READ TABLE temp201-nodes INDEX 1 INTO temp9.
    sy-tabix = temp10.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp204 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp203.
    sy-tabix = temp204.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp12 = sy-tabix.
    READ TABLE temp203-nodes INDEX 2 INTO temp11.
    sy-tabix = temp12.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp207 LIKE LINE OF lo_app->mt_tree.
    DATA temp208 LIKE sy-tabix.
    DATA temp209 LIKE LINE OF lo_app->mt_tree.
    DATA temp210 LIKE sy-tabix.
    DATA temp211 LIKE LINE OF lo_app->mt_tree.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp205 app = lo_app.
    ...
    temp208 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp207.
    sy-tabix = temp208.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp210 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp209.
    sy-tabix = temp210.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp212 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp211.
    sy-tabix = temp212.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    DATA temp215 LIKE LINE OF lo_app->mt_tree.
    DATA temp216 LIKE sy-tabix.
    DATA temp217 LIKE LINE OF lo_app->mt_tree.
    DATA temp218 LIKE sy-tabix.
    DATA temp13 LIKE LINE OF temp217-nodes.
    DATA temp14 LIKE sy-tabix.
    DATA temp219 LIKE LINE OF lo_app->mt_tree.
    DATA temp220 LIKE sy-tabix.
    DATA temp15 LIKE LINE OF temp219-nodes.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp213 app = lo_app.
    ...
    temp216 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp215.
    sy-tabix = temp216.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp218 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp217.
    sy-tabix = temp218.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp14 = sy-tabix.
    READ TABLE temp217-nodes INDEX 1 INTO temp13.
    sy-tabix = temp14.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp220 = sy-tabix.
    READ TABLE lo_app->mt_tree INDEX 1 INTO temp219.
    sy-tabix = temp220.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp16 = sy-tabix.
    READ TABLE temp219-nodes INDEX 1 INTO temp15.
    sy-tabix = temp16.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
CLASS ltcl_app_two_tab_drefs IMPLEMENTATION.
  ...
  METHOD constructor.
    DATA temp221 LIKE REF TO mt_tab.
    DATA temp222 LIKE REF TO mt_tab.
    GET REFERENCE OF mt_tab INTO temp221.
CREATE OBJECT mo_ref1 TYPE ltcl_app_inner_335 EXPORTING ir_data = temp221.

    GET REFERENCE OF mt_tab INTO temp222.
CREATE OBJECT mo_ref2 TYPE ltcl_app_inner_335 EXPORTING ir_data = temp222.
  ENDMETHOD.
...
CLASS ltcl_test_two_tab_refs IMPLEMENTATION.
  ...
  METHOD test_both_get_name_ref.
    ...
    DATA temp223 TYPE ltcl_app_two_tab_drefs=>ty_t_tab.
    DATA temp224 LIKE LINE OF temp223.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp225 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    DATA temp226 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp227 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA ls_ref1 LIKE temp226.
    DATA temp228 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp229 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA ls_ref2 LIKE temp228.
    ...
    lo_app->mt_tab = temp223.



    GET REFERENCE OF lt_attri INTO temp225.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp225 app = lo_app.
    lo_model->dissolve( ).
    lo_model->dissolve( ).
    lo_model->dissolve( ).
    ...
    READ TABLE lt_attri INTO temp227 WITH KEY name = `MO_REF1->MR_DATA->*`.
    IF sy-subrc = 0.
      temp226 = temp227.
    ENDIF.
    ...
    READ TABLE lt_attri INTO temp229 WITH KEY name = `MO_REF2->MR_DATA->*`.
    IF sy-subrc = 0.
      temp228 = temp229.
    ENDIF.
  ...
  METHOD test_canonical_search.
    ...
    DATA lo_app TYPE REF TO ltcl_app_two_tab_drefs.
    DATA temp230 TYPE ltcl_app_two_tab_drefs=>ty_t_tab.
    DATA temp231 LIKE LINE OF temp230.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp232 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    lo_app->mt_tab = temp230.



    GET REFERENCE OF lt_attri INTO temp232.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp232 app = lo_app.
    lo_model->dissolve( ).
    lo_model->dissolve( ).
    lo_model->dissolve( ).
...
CLASS ltcl_test_deep_nesting IMPLEMENTATION.
  ...
  METHOD test_deep_struct_writeback.
    ...
    DATA lo_app TYPE REF TO ltcl_app_complex.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp233 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    DATA lr TYPE REF TO z2ui5_if_ui5_types=>ty_s_attri.
    DATA lo_model_json TYPE REF TO z2ui5_if_ajson.
    CREATE OBJECT lo_app TYPE ltcl_app_complex.
    ...
    GET REFERENCE OF lt_attri INTO temp233.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp233 app = lo_app.
    lo_model->dissolve( ).
    lo_model->dissolve( ).
  ...
  METHOD test_deep_oref_writeback.
    ...
    DATA lo_app TYPE REF TO ltcl_app_complex.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp234 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    GET REFERENCE OF lt_attri INTO temp234.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp234 app = lo_app.
    lo_model->dissolve( ).
    lo_model->dissolve( ).
    lo_model->dissolve( ).
...
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    DATA lr TYPE REF TO z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp236 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp237 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp238 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA temp239 TYPE z2ui5_if_ui5_types=>ty_s_attri.
    DATA ls_simple LIKE temp238.
    CREATE OBJECT lo_app TYPE ltcl_app_complex.
...
CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp235 app = lo_app.
    ...
    READ TABLE lt_attri INTO temp237 WITH KEY name = `MO_MID->MV_MID`.
    IF sy-subrc = 0.
      temp236 = temp237.
    ENDIF.
    cl_abap_unit_assert=>assert_not_initial(
    ...
    READ TABLE lt_attri INTO temp239 WITH KEY name = `MV_SIMPLE`.
    IF sy-subrc = 0.
      temp238 = temp239.
    ENDIF.
...
CLASS ltcl_test_json_types IMPLEMENTATION.
  ...
  METHOD test_updates_integer.
    ...
    DATA lo_app TYPE REF TO ltcl_app_complex.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp240 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    DATA lr TYPE REF TO z2ui5_if_ui5_types=>ty_s_attri.
    DATA lo_model_json TYPE REF TO z2ui5_if_ajson.
    CREATE OBJECT lo_app TYPE ltcl_app_complex.
    ...
    GET REFERENCE OF lt_attri INTO temp240.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp240 app = lo_app.
    lo_model->dissolve( ).
  ...
  METHOD test_multiple_attrs_same_var.
    ...
    DATA lo_app TYPE REF TO ltcl_app_complex.
    DATA lt_attri TYPE z2ui5_if_ui5_types=>ty_t_attri.
    DATA temp241 LIKE REF TO lt_attri.
DATA lo_model TYPE REF TO z2ui5_cl_ui5_srv_model.
    ...
    GET REFERENCE OF lt_attri INTO temp241.

CREATE OBJECT lo_model TYPE z2ui5_cl_ui5_srv_model EXPORTING attri = temp241 app = lo_app.
    lo_model->dissolve( ).
