...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD event_no_busy.
    ...
    CLEAR temp29.
    INSERT `${$parameters>/newValue}` INTO TABLE temp29.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD event_prevent_default.
    ...
    CLEAR temp31.
    INSERT `$event.oSource.sId` INTO TABLE temp31.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD event_prevent_default_expr.
    ...
    CLEAR temp33.
    INSERT `${$parameters>/width}` INTO TABLE temp33.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD event_client_args.
    ...
    CLEAR temp35.
    INSERT `param1` INTO TABLE temp35.
  ...
  METHOD event_quote_escaped.
    ...
    CLEAR temp37.
    INSERT `Value changed to '{0}'` INTO TABLE temp37.
  ...
  METHOD event_backslash_escaped.
    ...
    CLEAR temp39.
    INSERT `\',alert(1),'` INTO TABLE temp39.
  ...
  METHOD event_lone_cr_escaped.
    ...
    DATA temp3 LIKE LINE OF temp41.
    DATA lt_arg LIKE temp41.
    DATA lv_event TYPE string.
    ...
    INSERT temp3 INTO TABLE temp41.
  ...
  METHOD event_placeholder_quoted.
    ...
    CLEAR temp43.
    INSERT `{0} Pressed` INTO TABLE temp43.
    ...
    CLEAR temp45.
    INSERT `{0?Pressed:Unpressed}` INTO TABLE temp45.
  ...
  METHOD json_basic.
    ...
    CLEAR temp47.
    INSERT `My Title` INTO TABLE temp47.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_nav_container.
    ...
    CLEAR temp49.
    INSERT `myContainer` INTO TABLE temp49.
    INSERT `to` INTO TABLE temp49.
    INSERT `myPage` INTO TABLE temp49.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp51.
    INSERT `myContainer` INTO TABLE temp51.
    INSERT `to` INTO TABLE temp51.
    INSERT `myPage` INTO TABLE temp51.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp53.
    INSERT `myContainer` INTO TABLE temp53.
    INSERT `to` INTO TABLE temp53.
    INSERT `myPage` INTO TABLE temp53.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp55.
    INSERT `myContainer` INTO TABLE temp55.
    INSERT `to` INTO TABLE temp55.
    INSERT `myPage` INTO TABLE temp55.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp57.
    INSERT `myContainer` INTO TABLE temp57.
    INSERT `to` INTO TABLE temp57.
    INSERT `myPage` INTO TABLE temp57.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_bind_element.
    ...
    DATA temp63 TYPE string_table.
    DATA temp65 TYPE string_table.
    CREATE OBJECT lo_event TYPE z2ui5_cl_ui5_srv_event.


    CLEAR temp59.
    INSERT `3` INTO TABLE temp59.
    INSERT `{/MT_TAB}` INTO TABLE temp59.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp61.
    INSERT `0` INTO TABLE temp61.
    INSERT `/MT_TAB` INTO TABLE temp61.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp65.
    INSERT `` INTO TABLE temp65.
    INSERT `{/MT_TAB}` INTO TABLE temp65.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_view_param.
    ...
    CLEAR temp67.
    INSERT `demoPanel` INTO TABLE temp67.
    INSERT `setExpanded` INTO TABLE temp67.
    INSERT `X` INTO TABLE temp67.
    cl_abap_unit_assert=>assert_equals(
    ...
    CLEAR temp69.
    INSERT `demoPanel` INTO TABLE temp69.
    INSERT `setExpanded` INTO TABLE temp69.
    INSERT `X` INTO TABLE temp69.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_empty_args.
    ...
    CLEAR temp71.
    INSERT `demoPanel` INTO TABLE temp71.
    INSERT `setExpanded` INTO TABLE temp71.
    INSERT `` INTO TABLE temp71.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_object_arg.
    ...
    CLEAR temp73.
    INSERT `{"KEY":"K1"}` INTO TABLE temp73.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_placeholder_stays_string.
    ...
    CLEAR temp75.
    INSERT `MESSAGE_TOAST` INTO TABLE temp75.
    INSERT `show` INTO TABLE temp75.
    INSERT `{0} Pressed` INTO TABLE temp75.
    cl_abap_unit_assert=>assert_equals(
  ...
  METHOD json_escaping.
    ...
    CLEAR temp77.
    INSERT `he said "hi" \ bye` INTO TABLE temp77.
    cl_abap_unit_assert=>assert_equals(
