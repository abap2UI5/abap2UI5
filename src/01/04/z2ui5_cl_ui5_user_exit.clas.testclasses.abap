...
CLASS ltcl_test_user_exit IMPLEMENTATION.
  ...
  METHOD test_no_secure_ctx_header.
    ...
    temp1 = sy-subrc.
    temp2 = boolc( temp1 = 0 ).
    cl_abap_unit_assert=>assert_false( temp2 ). "#EC CI_SORTSEQ
    ...
    temp4 = sy-subrc.
    temp3 = boolc( temp4 = 0 ).
    cl_abap_unit_assert=>assert_true( temp3 ). "#EC CI_SORTSEQ
  ...
  METHOD test_context_app_start.
    ...
    temp7-n = `app_start`.
    temp7-v = `%2Fns%2Fzcl_my_app`.
    INSERT temp7 INTO TABLE temp6.
    temp2-t_params = temp6.
