CLASS z2ui5_cl_http_handler_icf_conf DEFINITION
  PUBLIC
  CREATE PROTECTED.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory_cloud
      ...
      RETURNING
        VALUE(result) TYPE REF TO z2ui5_cl_http_handler_icf_conf.
...
CLASS z2ui5_cl_http_handler_icf_conf IMPLEMENTATION.
