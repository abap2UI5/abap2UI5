...
| [`open-abap-asxml-private-attributes`](items/open-abap-asxml-private-attributes.md) | 'kernel_call_transformation (lcl_heap=>add_object) and kernel_ixml_xml_to_data reach the attributes of a serializable object by `ASSIGN iv_ref->(name)`; a private attribute is a #field in the transpiled class, the walker in @abaplint/runtime reads undefined, and the ASSERT on sy-subrc dies. A system serializes private attributes' | medium | 2026-09-02 | open-abap/open-abap-core |
