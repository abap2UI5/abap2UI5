...
|---|---|---|---|---|
| [`embed-as-reuse-component`](items/embed-as-reuse-component.md) | Stage 2 is done - the frontend state is per component (core/Context.js) and several z2ui5.Component instances run side by side on one page; the wrapping custom control z2ui5.reuse.Container ships in app/webapp/reuse and as @abap2ui5/embed-control; stage 1 (the embedded flag that turns the page-wide behaviours off) stays open until there is real demand | low | 2026-09-23 | abap2UI5/abap2UI5 |
