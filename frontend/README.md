...
| `npm/` | the manifest, README and `ui5.yaml` of the npm package `@abap2ui5/embed-control` — `npm run pack:embed-control` (`tools/pack-frontend.mjs`) puts them around `app/webapp` and its `Component-preload.js` |
